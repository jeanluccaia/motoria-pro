...
export function CollectiveClassesSection() {
  return (
    <Section id="aulas-coletivas" bg="black" className="relative overflow-hidden py-12 md:py-16 lg:py-20">
      <Reveal>
          ...
          <div className="grid gap-8 lg:grid-cols-[auto_1fr_auto] lg:items-center">
            ...
            <div className="max-w-3xl">
              ...
              <p className="mt-4 max-w-2xl text-sm leading-[1.65] text-lf-muted md:text-base">
                Musculação + aulas coletivas no mesmo plano. Muay Thai, Pilates, Spinning, Zumba e outras modalidades já entram na mensalidade da sua unidade.
              </p>
