    ...
    <Section id="planos" bg="cream" className="relative overflow-hidden pt-16 pb-24 md:py-24 lg:py-28">
      ...
      <Reveal delay={0.32}>
        <div className="mt-5 flex flex-col gap-1 border-t border-[#D8D0C0] pt-5 text-[11px] text-[#6E675C] sm:flex-row sm:justify-between">
          <p>Oferta válida até 14/09. Mensal Recorrente: 1º mês R$ 69,90, sem fidelidade e cancelamento sem multa. Power Plus: 1º mês R$ 0,00 + taxa de inscrição R$ 9,90, fidelidade de 12 meses.</p>
