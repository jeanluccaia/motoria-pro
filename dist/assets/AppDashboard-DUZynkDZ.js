import{r as o,j as e}from"./vendor-BnG4zNoI.js";import"./landing-C30UQtua.js";const Ra=["Resultado da partida","Mais ou menos gols","Ambos marcam","Handicap","Empate devolve","Chance dupla","Primeiro gol","Escanteios","Cartões","Múltipla"],Da=["Brasileirão","Libertadores","Champions","Premier League","La Liga","Copa do Brasil","Série B"],aa=[{tipo:"Resultado da partida",ref:"1.85"},{tipo:"Mais ou menos gols",ref:"1.90"},{tipo:"Ambos marcam",ref:"1.95"},{tipo:"Handicap",ref:"2.10"},{tipo:"Empate devolve",ref:"1.65"},{tipo:"Chance dupla",ref:"1.40"}],Se={"Resultado da partida":"1.85","Mais ou menos gols":"1.90","Ambos marcam":"1.95",Handicap:"2.10","Empate devolve":"1.65","Chance dupla":"1.40","Primeiro gol":"3.50",Escanteios:"1.90",Cartões:"1.85",Múltipla:"4.00"},te=[{label:"Analisando odd informada",pct:16},{label:"Calculando chance estimada",pct:32},{label:"Medindo exposição da banca",pct:52},{label:"Avaliando retorno esperado",pct:70},{label:"Gerando leitura da IA",pct:86},{label:"Compilando painel de análise",pct:96}],ge="motoria_token",la="motoria_hist_v2",ra=8,ta="https://pay.kiwify.com.br/DIVD8zl",da="motoria_bankroll_entries",pa="motoria_bankroll_cfg",Ba=["Resultado da partida","Mais ou menos gols","Ambos marcam","Handicap","Empate devolve","Chance dupla","Primeiro gol","Escanteios","Cartões","Múltipla"];function Le(s){return 1/s*100}function $a(s){return s<=1.4?4:s<=1.7?4.8:s<=2.2?5.5:s<=3?6.5:8}function Ta(s,i){return s/100*(i-1)*100-(1-s/100)*100}function ia(s){const i=Le(s),n=Math.min(100,Math.round(100-i));let g,c,x;return n<=30?(g="BAIXO",c="#22C55E",x="FAVORÁVEL"):n<=60?(g="MODERADO",c="#F59E0B",x="NEUTRO"):n<=80?(g="ALTO",c="#F97316",x="DESFAVORÁVEL"):(g="CRÍTICO",c="#EF4444",x="DESFAVORÁVEL"),{score:n,label:g,color:c,verdict:x}}function ie(s,i){const n=s.match(new RegExp(`^${i}:[^\\n]*\\n([\\s\\S]*?)(?=\\n[A-Z_]{3,}:|$)`,"m")),g=s.match(new RegExp(`^${i}:\\s*(.+)`,"m"));return(n?n[1].trim():null)||(g?g[1].trim():null)}function Va(s){return{riscoPrincipal:ie(s,"RISCO_PRINCIPAL"),cenarioNecessario:ie(s,"CENARIO_NECESSARIO"),oQuePodeDarErrado:ie(s,"O_QUE_PODE_DAR_ERRADO"),leituraConservadora:ie(s,"LEITURA_CONSERVADORA"),alertaFinal:ie(s,"ALERTA_FINAL")}}function Pa(s){try{const i=s.match(/\{[\s\S]*\}/);if(i)return JSON.parse(i[0])}catch{}return null}function me(s,i){if(!i?.teams||!s)return null;if(i.teams[s])return i.teams[s];const n=s.toLowerCase(),g=Object.keys(i.teams).find(c=>n.includes(c.toLowerCase())||c.toLowerCase().includes(n));return g?i.teams[g]:null}function sa(s,i,n){return n?.h2h&&(n.h2h[`${s}-${i}`]||n.h2h[`${i}-${s}`])||null}function Wa(){try{return JSON.parse(localStorage.getItem(la)||"[]")}catch{return[]}}function _a(s){try{localStorage.setItem(la,JSON.stringify(s))}catch{}}function Ha(s){return s.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",second:"2-digit"})}function Ya(){return new Date().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",second:"2-digit"})}function he(s){const i=(s||"").toLowerCase();return i.includes("serie b")||i.includes("série b")?"Série B":i.includes("brasileir")||i.includes("brazil")&&i.includes("serie a")?"Brasileirão":i.includes("libertad")?"Libertadores":i.includes("champions")?"Champions":i.includes("premier league")?"Premier League":i.includes("la liga")||i.includes("laliga")||i.includes("primera division")?"La Liga":i.includes("copa do brasil")?"Copa do Brasil":i.includes("bundesliga")?"Bundesliga":i.includes("ligue 1")?"Ligue 1":""}function Ga(){try{return JSON.parse(localStorage.getItem(da)||"[]")}catch{return[]}}function Ee(s){try{localStorage.setItem(da,JSON.stringify(s))}catch{}}function Ua(){try{return JSON.parse(localStorage.getItem(pa)||"{}")}catch{return{}}}function oa(s){try{localStorage.setItem(pa,JSON.stringify(s))}catch{}}function ca(s,i){if(!i||i<=0)return null;let n=i,g=0,c=0,x=0,u=0,I=0,f=0,m=0,y=0;const G=[...s].sort((w,W)=>w.ts-W.ts);for(const w of G)if(w.resultado!=="Anulada"){if(y++,w.resultado==="Ganhou"){const W=parseFloat(w.valor)*(parseFloat(w.odd)-1);n+=W,g+=W,x++,m=m>0?m+1:1}else n-=parseFloat(w.valor),c+=parseFloat(w.valor),u++,m=m<0?m-1:-1;m<0&&Math.abs(m)>f&&(f=Math.abs(m)),I=m}const D=g-c,U=y>0?D/(c+g)*100:0,_=y>0?x/y*100:0;return{saldo:n,lucroTotal:D,roi:U,acerto:_,wins:x,losses:u,totalApos:y,streak:I,maxStreak:f}}function Ja(s,i){const n=[];if(!i||i<=0||s.length===0)return n;const g=s[0],c=parseFloat(g?.valor||0)/i*100;c>10?n.push({type:"danger",msg:`Última entrada: ${c.toFixed(1)}% da banca — exposição acima do recomendado.`}):c>=5&&n.push({type:"warn",msg:`Última entrada: ${c.toFixed(1)}% da banca — atenção à gestão.`});const x=ca(s,i);return x&&(x.streak<=-3&&n.push({type:"danger",msg:`Sequência de ${Math.abs(x.streak)} derrotas seguidas — revise a estratégia.`}),x.lucroTotal<0&&n.push({type:"warn",msg:`Resultado acumulado negativo: R$ ${Math.abs(x.lucroTotal).toFixed(2)} abaixo do investido.`})),n}const Ka=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("rect",{x:"1.5",y:"1.5",width:"4.5",height:"4.5",rx:"1.2",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("rect",{x:"8",y:"1.5",width:"4.5",height:"4.5",rx:"1.2",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("rect",{x:"1.5",y:"8",width:"4.5",height:"4.5",rx:"1.2",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("rect",{x:"8",y:"8",width:"4.5",height:"4.5",rx:"1.2",stroke:"currentColor",strokeWidth:"1.3"})]}),qa=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("path",{d:"M2 11L5 7.5L8 9.5L12 3.5",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",strokeLinejoin:"round"}),e.jsx("circle",{cx:"5",cy:"7.5",r:"1",fill:"currentColor"}),e.jsx("circle",{cx:"8",cy:"9.5",r:"1",fill:"currentColor"}),e.jsx("circle",{cx:"12",cy:"3.5",r:"1",fill:"currentColor"})]}),Qa=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("path",{d:"M2 10V6M5 10V4M8 10V7M11 10V3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round"}),e.jsx("path",{d:"M1 12.5h12",stroke:"currentColor",strokeWidth:"1.2",strokeLinecap:"round",opacity:".4"})]}),Za=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("circle",{cx:"7",cy:"7",r:"2",fill:"currentColor",fillOpacity:".9"}),e.jsx("path",{d:"M3.5 3.5a5 5 0 0 0 0 7M10.5 3.5a5 5 0 0 1 0 7",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round"})]}),Xa=()=>e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M7 1.5l1.5 3.2L12 5.3l-2.5 2.4.6 3.4L7 9.5l-3.1 1.6.6-3.4L2 5.3l3.5-.6L7 1.5z",stroke:"currentColor",strokeWidth:"1.3",strokeLinejoin:"round"})}),er=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("circle",{cx:"7",cy:"7",r:"5",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M7 4.5V7L8.8 8.8",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round"})]}),ar=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("circle",{cx:"7",cy:"7",r:"2",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M7 1v2M7 11v2M1 7h2M11 7h2M3.22 3.22l1.41 1.41M9.37 9.37l1.41 1.41M3.22 10.78l1.41-1.41M9.37 4.63l1.41-1.41",stroke:"currentColor",strokeWidth:"1.2",strokeLinecap:"round"})]}),rr=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("rect",{x:"1.5",y:"3",width:"11",height:"9.5",rx:"1.5",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M1.5 6h11",stroke:"currentColor",strokeWidth:"1.2"}),e.jsx("path",{d:"M4.5 1.5V4M9.5 1.5V4",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round"}),e.jsx("circle",{cx:"4.5",cy:"9",r:".9",fill:"currentColor",opacity:".55"}),e.jsx("circle",{cx:"7",cy:"9",r:".9",fill:"currentColor",opacity:".55"}),e.jsx("circle",{cx:"9.5",cy:"9",r:".9",fill:"currentColor",opacity:".55"})]}),tr=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("rect",{x:"1.5",y:"5",width:"11",height:"8",rx:"1.4",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M4 5V3.5a3 3 0 0 1 6 0V5",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round"}),e.jsx("circle",{cx:"7",cy:"9",r:"1.2",fill:"currentColor",opacity:".7"})]});function Oe({mod:s,title:i,desc:n}){return e.jsxs("div",{className:"ap-content",children:[e.jsx("div",{className:"ap-panel-hdr",children:e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:s}),e.jsx("div",{className:"ap-panel-title",children:i})]})}),e.jsxs("div",{className:"ap-coming-panel",children:[e.jsx("div",{className:"ap-coming-icon","aria-hidden":"true",children:e.jsxs("svg",{width:"22",height:"22",viewBox:"0 0 22 22",fill:"none",children:[e.jsx("rect",{x:"1.5",y:"1.5",width:"19",height:"19",rx:"5",stroke:"rgba(255,255,255,.1)",strokeWidth:"1.5"}),e.jsx("path",{d:"M8 11h6M11 8v6",stroke:"rgba(255,255,255,.15)",strokeWidth:"1.5",strokeLinecap:"round"})]})}),e.jsx("p",{className:"ap-coming-desc",children:n}),e.jsx("div",{className:"ap-coming-tag",children:"Em desenvolvimento · Próxima versão"})]})]})}function na({id:s,options:i,value:n,onChange:g,placeholder:c}){const[x,u]=o.useState(!1),I=o.useRef(null);return o.useEffect(()=>{if(!x)return;function f(y){y.key==="Escape"&&u(!1)}function m(y){I.current&&!I.current.contains(y.target)&&u(!1)}return document.addEventListener("keydown",f),document.addEventListener("mousedown",m),()=>{document.removeEventListener("keydown",f),document.removeEventListener("mousedown",m)}},[x]),e.jsxs("div",{className:"sel-wrap",ref:I,children:[e.jsxs("button",{id:s,type:"button",className:`sel-trigger${x?" sel-trigger-open":""}`,onClick:()=>u(f=>!f),"aria-haspopup":"listbox","aria-expanded":x,children:[e.jsx("span",{className:`sel-val${c&&!i.includes(n)?" sel-placeholder":""}`,children:c&&!i.includes(n)?c:n}),e.jsx("span",{className:`sel-chev${x?" sel-chev-up":""}`,"aria-hidden":"true",children:e.jsx("svg",{width:"10",height:"10",viewBox:"0 0 12 12",fill:"none",children:e.jsx("path",{d:"M2.5 4.5L6 8L9.5 4.5",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})})})]}),x&&e.jsxs("ul",{className:"sel-list",role:"listbox","aria-label":c||"Opções",children:[c&&e.jsxs("li",{role:"option","aria-selected":!i.includes(n),className:`sel-opt${i.includes(n)?"":" sel-opt-on"}`,onMouseDown:f=>f.preventDefault(),onClick:()=>{g(""),u(!1)},children:[e.jsx("span",{className:"sel-check","aria-hidden":"true",children:!i.includes(n)&&e.jsx("svg",{width:"9",height:"9",viewBox:"0 0 12 12",fill:"none",children:e.jsx("path",{d:"M2.5 6L5 8.5L9.5 3.5",stroke:"currentColor",strokeWidth:"1.7",strokeLinecap:"round",strokeLinejoin:"round"})})}),e.jsx("span",{className:"sel-opt-text sel-opt-dim",children:c})]}),i.map(f=>e.jsxs("li",{role:"option","aria-selected":f===n,className:`sel-opt${f===n?" sel-opt-on":""}`,onMouseDown:m=>m.preventDefault(),onClick:()=>{g(f),u(!1)},children:[e.jsx("span",{className:"sel-check","aria-hidden":"true",children:f===n&&e.jsx("svg",{width:"9",height:"9",viewBox:"0 0 12 12",fill:"none",children:e.jsx("path",{d:"M2.5 6L5 8.5L9.5 3.5",stroke:"currentColor",strokeWidth:"1.7",strokeLinecap:"round",strokeLinejoin:"round"})})}),e.jsx("span",{className:"sel-opt-text",children:f})]},f))]})]})}function dr(){o.useEffect(()=>{const a=document.title;return document.title="MotorIA Risk Engine™",()=>{document.title=a}},[]);const[s,i]=o.useState(new Date);o.useEffect(()=>{const a=setInterval(()=>i(new Date),1e3);return()=>clearInterval(a)},[]);const[n,g]=o.useState(!1);o.useEffect(()=>{try{const a=new URLSearchParams(window.location.search),r=a.get("t")||a.get("token");if(r&&r.length>10){localStorage.setItem(ge,r),ue(r),g(!0),window.history.replaceState(null,"",window.location.pathname);const d=setTimeout(()=>g(!1),4200);return()=>clearTimeout(d)}}catch{}},[]);const[c,x]=o.useState(!1),[u,I]=o.useState("jogos"),[f,m]=o.useState("lista");function y(a){I(a),x(!1),a==="jogos"&&(m("lista"),L(null),O(""))}const[G,D]=o.useState(""),[U,_]=o.useState(""),[w,W]=o.useState("Resultado da partida"),[B,J]=o.useState(""),[be,Ie]=o.useState(""),[sr,xa]=o.useState(""),[M,H]=o.useState(!1),[C,Me]=o.useState(0),[$,K]=o.useState(0),[se,O]=o.useState(""),[h,L]=o.useState(null),[z,ga]=o.useState(Wa),[q,ue]=o.useState(()=>localStorage.getItem(ge)||""),[Fe,ma]=o.useState(null),[Re,ha]=o.useState(null),[ba,De]=o.useState(null),[T,Be]=o.useState([]),[Q,fe]=o.useState(!1),[ve,$e]=o.useState(""),[or,ua]=o.useState(null),[Te,fa]=o.useState(null),[l,Z]=o.useState(null),[oe,va]=o.useState("todos"),[V,je]=o.useState(Ga),[ja,Ve]=o.useState(Ua),[Pe,We]=o.useState(!1),[ka,ke]=o.useState(!1),[A,Y]=o.useState({valor:"",odd:"",resultado:"Ganhou",mercado:"Resultado da partida",obs:""}),[_e,He]=o.useState(""),[F,wa]=o.useState(null),[Na,we]=o.useState(null),[Ye,ne]=o.useState("");o.useEffect(()=>{fetch("/jogos-data.json").then(a=>a.json()).then(wa).catch(()=>{})},[]);function Ne(){fe(!0),$e(""),Be([]),fetch("/api/matches").then(a=>{if(!a.ok)throw new Error(`HTTP ${a.status}`);return a.json()}).then(a=>{const r=Array.isArray(a.matches)?a.matches:[],d=a.source||"unknown";console.log("[MotorIA] API games:",r),r.length===0&&console.log("[MotorIA] No real games returned — source:",d),Be(r),ua(d),fa(a.updatedAt?new Date(a.updatedAt):new Date),fe(!1)}).catch(a=>{console.log("[MotorIA] API failed —",a.message||a),$e("network"),fe(!1)})}o.useEffect(()=>{u==="jogos"&&(T.length>0&&!ve||Ne())},[u]);const le=parseFloat((B||"").replace(",",".")),ye=B&&!isNaN(le)&&le>=1.01?ia(le):null,X=z.length?Math.round(z.reduce((a,r)=>a+(r.score||0),0)/z.length):null,Ge=z[0]||null;async function Ue({jogoVal:a,campVal:r,tipoVal:d,oddVal:j,valorVal:t}){const p=parseFloat(String(j).replace(",","."));H(!0),O(""),L(null),Me(0),K(te[0].pct);let k=0;const S=setInterval(()=>{k=Math.min(k+1,te.length-1),Me(k),K(te[k].pct)},820);try{let v="";if(F&&a&&a!=="Aposta"){const R=a.split(" × ");if(R.length===2){const ce=me(R[0].trim(),F),xe=me(R[1].trim(),F);ce&&(v+=` | ${R[0].trim()} forma: ${ce.forma.join("-")} GM:${ce.gm} GS:${ce.gs}`),xe&&(v+=` | ${R[1].trim()} forma: ${xe.forma.join("-")} GM:${xe.gm} GS:${xe.gs}`);const re=sa(R[0].trim(),R[1].trim(),F);re&&(v+=` | H2H: H${re.h} D${re.d} A${re.a} méd.${re.mediaGols}gols`)}}const E=`Jogo: ${a||"não informado"} | Campeonato: ${r||"não informado"} | Mercado: ${d} | Odd: ${j}${t?` | Valor: R$${t}`:""}${v}`,b=await fetch("/api/chat",{method:"POST",headers:{"Content-Type":"application/json",...q?{"x-motoria-token":q}:{}},body:JSON.stringify({tool:"aposta",userMessage:E})});if(clearInterval(S),b.status===402){L({locked:!0,signals:[]}),K(100),setTimeout(()=>H(!1),280);return}if(!b.ok){const R=await b.json().catch(()=>({}));O(R.error||"Erro ao processar análise."),H(!1);return}const N=await b.json();if(N.credits!==void 0&&ma(N.credits),N.token&&(localStorage.setItem(ge,N.token),ue(N.token)),N.locked){L({locked:!0,signals:N.preview?.signals||[]}),K(100),setTimeout(()=>H(!1),280);return}const ee=N.content?.[0]?.text||"",ze=Pa(ee),P=Le(p),ae=$a(p),de=P/(1-ae/100),pe=Math.min(de,99),Ce=Ta(P,p),Ma=ia(p),Fa=Math.min(100,Math.round((100-pe)*1.1)),Xe=parseFloat(t)||100,Ae={id:Math.floor(Math.random()*8e3)+2e3,ts:Ya(),jogo:a||"Aposta",tipo:d,odd:p,impl:P.toFixed(2),justa:pe.toFixed(2),vig:ae.toFixed(2),ev:Ce.toFixed(2),perda:(100-P).toFixed(1),exposure:Fa,valorAposta:Xe,valorRisco:(Xe*(100-P)/100).toFixed(2),...Ma,ai:Va(ee),aiResult:ze};L(Ae),ha(Ae.id);const ea=[Ae,...z].slice(0,ra);ga(ea),_a(ea),K(100),setTimeout(()=>H(!1),280)}catch{clearInterval(S),O("Erro de conexão. Tente novamente."),H(!1)}}function ya(a){a.preventDefault();const r=parseFloat((B||"").replace(",","."));if(!B||isNaN(r)||r<1.01){O("Informe uma odd válida (mínimo 1.01).");return}Ue({jogoVal:G,campVal:U,tipoVal:w,oddVal:B,valorVal:be})}function Je(a,r){if(!a||!r)return;const d=l?`${l.home} × ${l.away}`:G,j=l?.campeonato||U;W(a),J(String(r)),m("resultado"),Ue({jogoVal:d,campVal:j,tipoVal:a,oddVal:String(r),valorVal:be||"100"})}function Ke(a){L(a),D(a.jogo||""),J(String(a.odd)),I("nova")}function za(){L(null),O(""),D(""),J(""),Ie(""),xa(""),_(""),Z(null),we(null),ne(""),m("lista")}function Ca(a){const r=he(a.league);D(`${a.home} × ${a.away}`),_(r),Z({...a,campeonato:r}),m("mercado")}function qe(){const a=parseFloat(_e.replace(",","."));if(!a||a<=0)return;const r={bancaInicial:a};Ve(r),oa(r),He("")}function Aa(){const a=parseFloat(A.valor.replace(",",".")),r=parseFloat(A.odd.replace(",","."));if(!a||a<=0||!r||r<1.01)return;const j=[{id:Math.random().toString(36).slice(2),ts:Date.now(),valor:a,odd:r,resultado:A.resultado,mercado:A.mercado,obs:A.obs.trim()},...V];je(j),Ee(j),Y({valor:"",odd:"",resultado:"Ganhou",mercado:"Resultado da partida",obs:""}),We(!1)}function Sa(a){const r=V.filter(d=>d.id!==a);je(r),Ee(r)}function Ea(){je([]),Ee([]),ke(!1)}function Qe(a){const r=a.aiResult,d={"BOA ENTRADA":{color:"#1DB954",icon:"✅"},"BOA, MAS COM CUIDADO":{color:"#8BC34A",icon:"⚠️"},CUIDADO:{color:"#F0B429",icon:"⚠️"},"ENTRADA FRACA":{color:"#FF8C00",icon:"⚠️"},DESFAVORÁVEL:{color:"#E8641A",icon:"❌"},"RISCO ALTO":{color:"#E53E3E",icon:"❌"},"NÃO COMPENSA":{color:"#C0392B",icon:"❌"}},j=r?.status||"CUIDADO",t=d[j]||{color:"#FF8C00",icon:"⚠️"},p=r?.frase||"",k=r?.chance_ganhar!=null?`${Number(r.chance_ganhar).toFixed(0)}%`:`${a.impl}%`,S=r?.odd_ideal!=null?Number(r.odd_ideal).toFixed(2):a.justa,v=r?.vantagem!=null?Number(r.vantagem):null;let E=null,b="#999",N="";v!=null&&(v>5?(E="SIM",b="#1DB954",N="mercado favorável"):v>=-5?(E="TALVEZ",b="#F0B429",N="mercado neutro"):(E="NÃO",b="#E53E3E",N="mercado desfavorável"));const ee=r?.valor_em_risco!=null&&Number(r.valor_em_risco)>0?Number(r.valor_em_risco):parseFloat(a.valorRisco)||null,ze=ee?`R$ ${ee.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})}`:"—",P=r?.bullets||[],ae=r?.alerta||a.ai?.alertaFinal||a.ai?.riscoPrincipal||"",de=ba===a.id;return e.jsxs("div",{className:"db-result-card",children:[e.jsxs("div",{className:"db-rc-header",children:[e.jsx("div",{className:"db-rc-event",children:a.jogo!=="Aposta"?a.jogo:a.tipo}),e.jsxs("div",{className:"db-rc-meta",children:[a.jogo!=="Aposta"&&e.jsx("span",{className:"db-rc-badge",children:a.tipo}),e.jsxs("span",{className:"db-rc-odd",children:["Odd ",a.odd.toFixed(2)]})]})]}),e.jsx("div",{className:"db-rc-divider"}),e.jsxs("div",{className:"db-status-badge",style:{background:`${t.color}1A`,borderLeftColor:t.color},children:[e.jsx("span",{className:"db-status-icon","aria-hidden":"true",children:t.icon}),e.jsx("span",{className:"db-status-text",style:{color:t.color},children:j})]}),p&&e.jsxs("div",{className:"db-frase",children:['"',p,'"']}),e.jsxs("div",{className:"db-ind-grid",children:[e.jsxs("div",{className:"db-ind-card",children:[e.jsx("div",{className:"db-ind-label",children:"CHANCE DE GANHAR"}),e.jsx("div",{className:"db-ind-value",children:k})]}),e.jsxs("div",{className:"db-ind-card",children:[e.jsx("div",{className:"db-ind-label",children:"ODD IDEAL"}),e.jsx("div",{className:"db-ind-value",children:S}),e.jsx("div",{className:"db-ind-micro",children:"a odd que faria essa aposta equilibrada"})]}),e.jsxs("div",{className:"db-ind-card",children:[e.jsx("div",{className:"db-ind-label",children:"VALE A PENA?"}),E?e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"db-ind-value",style:{color:b},children:E}),e.jsx("div",{className:"db-ind-micro",children:N}),v!=null&&e.jsx("div",{className:"db-ind-pct",children:v>=0?`+${v}%`:`${v}%`})]}):e.jsx("div",{className:"db-ind-value",style:{color:"var(--t3)"},children:"—"})]}),e.jsxs("div",{className:"db-ind-card",children:[e.jsx("div",{className:"db-ind-label",children:"VALOR EM RISCO"}),e.jsx("div",{className:"db-ind-value",style:{color:"#FF8C00"},children:ze}),e.jsx("div",{className:"db-ind-micro",children:"com base no valor que você informou"})]})]}),P.length>0&&e.jsxs("div",{className:"db-bullets-block",children:[e.jsx("div",{className:"db-bullets-title",children:"POR QUE ESSE CENÁRIO"}),P.map((pe,Ce)=>e.jsxs("div",{className:"db-bullet-item",children:[e.jsx("span",{className:"db-bullet-dot","aria-hidden":"true",children:"•"}),e.jsx("span",{className:"db-bullet-text",children:pe})]},Ce))]}),ae&&e.jsxs("div",{className:"db-alerta-block",role:"alert",children:[e.jsx("span",{className:"db-alerta-icon","aria-hidden":"true",children:"⚠️"}),e.jsx("p",{className:"db-alerta-text",children:ae})]}),e.jsx("div",{className:"db-rc-footer-divider"}),e.jsxs("div",{className:"db-rc-footer-row",children:[e.jsx("span",{className:"db-rc-footer-note",children:"Análise com odd de referência. Use a odd real da sua casa de apostas."}),e.jsx("button",{className:`db-copy-btn${de?" db-copy-btn-done":""}`,onClick:()=>Oa(a),type:"button",children:de?"✓ Copiado!":"📋 Copiar análise"})]})]})}function Ze(a=[]){return e.jsxs("div",{className:"lk-wrap",children:[e.jsxs("div",{className:"lk-preview-card",children:[e.jsxs("div",{className:"lk-header",children:[e.jsx("div",{className:"lk-header-event",children:"█████████ × █████████"}),e.jsxs("div",{className:"lk-header-meta",children:[e.jsx("span",{className:"lk-badge-blur",children:"████████"}),e.jsx("span",{className:"lk-odd-blur",children:"Odd █.██"})]})]}),e.jsx("div",{className:"lk-divider"}),e.jsxs("div",{className:"lk-risk-row",children:[e.jsxs("div",{children:[e.jsx("span",{className:"lk-section-label",children:"RISCO DA APOSTA"}),e.jsxs("div",{className:"lk-score-blur",children:["██",e.jsx("span",{className:"lk-score-denom",children:"/100"})]})]}),e.jsx("div",{className:"lk-level-blur",children:"███████"})]}),e.jsx("div",{className:"lk-bar-wrap",children:e.jsx("div",{className:"lk-bar-track",children:e.jsx("div",{className:"lk-bar-fill"})})}),e.jsx("div",{className:"lk-divider"}),e.jsxs("div",{className:"lk-signals",children:[e.jsx("span",{className:"lk-section-label",children:"SINAIS DETECTADOS"}),a.map((r,d)=>e.jsxs("div",{className:"lk-signal",children:[e.jsx("span",{className:"lk-signal-dot","aria-hidden":"true"}),e.jsx("span",{children:r})]},d))]}),e.jsx("div",{className:"lk-divider"}),e.jsxs("div",{className:"lk-ai-row",children:[e.jsx("span",{className:"lk-section-label",children:"LEITURA DA IA"}),e.jsxs("div",{className:"lk-ai-blur",children:[e.jsx("span",{className:"lk-ai-dot","aria-hidden":"true"}),e.jsx("span",{children:"██████████████████"})]}),e.jsx("div",{className:"lk-ai-text-blur",children:"████████████████████████████████████"})]}),e.jsxs("div",{className:"lk-overlay",children:[e.jsx("div",{className:"lk-lock-icon","aria-hidden":"true",children:e.jsxs("svg",{width:"28",height:"28",viewBox:"0 0 24 24",fill:"none",children:[e.jsx("rect",{x:"3",y:"11",width:"18",height:"11",rx:"2",stroke:"currentColor",strokeWidth:"1.5"}),e.jsx("path",{d:"M7 11V7a5 5 0 0 1 10 0v4",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round"}),e.jsx("circle",{cx:"12",cy:"16",r:"1.5",fill:"currentColor"})]})}),e.jsx("div",{className:"lk-lock-title",children:"Análise completa disponível com acesso"}),e.jsx("div",{className:"lk-lock-sub",children:"Score real · Chance estimada · Leitura completa da IA"}),e.jsx("a",{href:ta,className:"lk-cta-btn",target:"_blank",rel:"noopener noreferrer",children:"Desbloquear análise completa"}),e.jsx("div",{className:"lk-price-note",children:"Pagamento único · sem mensalidade · acesso imediato · R$ 27"})]})]}),e.jsx("button",{className:"lk-back",onClick:()=>{L(null),O("")},type:"button",children:"← Tentar outra análise"})]})}function Oa(a){const r=a.aiResult,d=r?.status||"—",j=r?.frase||"",t=r?.chance_ganhar!=null?`${Number(r.chance_ganhar).toFixed(0)}%`:`${a.impl}%`,p=r?.odd_ideal!=null?Number(r.odd_ideal).toFixed(2):a.justa,k=r?.vantagem!=null?Number(r.vantagem):null,S=k!=null?k>5?"SIM":k>=-5?"TALVEZ":"NÃO":"—",v=r?.alerta||a.ai?.alertaFinal||"",E=["🔍 MotorIA Pro — Análise de Aposta","",a.jogo!=="Aposta"?a.jogo:a.tipo,`Mercado: ${a.tipo}`,`Odd analisada: ${a.odd.toFixed(2)}`,"",`Status: ${d}`,j,"","📊 Números:",`• Chance de ganhar: ${t}`,`• Odd ideal: ${p}`,`• Vale a pena? ${S}`,v?"":null,v?`⚠️ ${v}`:null,"","—","Análise gerada pelo MotorIA Pro","motoriaopro.com.br"].filter(b=>b!==null).join(`
`);navigator.clipboard.writeText(E).catch(()=>{}),De(a.id),setTimeout(()=>De(b=>b===a.id?null:b),2e3)}const La=!!(q&&q.length>10),Ia=[{group:"ANÁLISE",items:[{id:"jogos",label:"Jogos de Hoje",Icon:rr},{id:"nova",label:"Análise Manual",Icon:qa,manual:!0},{id:"geral",label:"Visão Geral",Icon:Ka},{id:"banca",label:"Controle de Banca",Icon:tr},{id:"comparador",label:"Comparador",Icon:Qa,dim:!0}]},{group:"MERCADOS",items:[{id:"aovivo",label:"Ao Vivo",Icon:Za,live:!0,dim:!0},{id:"favoritos",label:"Favoritos",Icon:Xa,dim:!0}]},{group:"ARQUIVO",items:[{id:"historico",label:"Histórico",Icon:er,badge:z.length||null}]},{group:"SISTEMA",items:[{id:"config",label:"Configurações",Icon:ar}]}];return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:ir}),c&&e.jsx("div",{className:"ap-overlay",onClick:()=>x(!1),"aria-hidden":"true"}),n&&e.jsxs("div",{className:"ap-access-banner",role:"status","aria-live":"polite",children:[e.jsx("span",{className:"ap-access-banner-dot","aria-hidden":"true"}),"Acesso ativado — plataforma pronta para uso"]}),e.jsxs("div",{className:"ap-shell",children:[e.jsx("header",{className:"ap-topbar",children:e.jsxs("div",{className:"ap-topbar-row",children:[e.jsxs("div",{className:"ap-topbar-left",children:[e.jsxs("button",{className:"ap-hamburger",onClick:()=>x(a=>!a),"aria-label":"Menu","aria-expanded":c,children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]}),e.jsxs("div",{className:"ap-topbar-brand",children:[e.jsx("div",{className:"ap-logo-mark","aria-hidden":"true",children:e.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 14 14",fill:"none",children:[e.jsx("path",{d:"M7 1L13 4V10L7 13L1 10V4L7 1Z",fill:"#060608"}),e.jsx("path",{d:"M7 1L13 4V10L7 13L1 10V4L7 1Z",fill:"currentColor",fillOpacity:".95"})]})}),e.jsx("span",{className:"ap-topbar-name",children:"MotorIA"}),e.jsx("span",{className:"ap-topbar-sep","aria-hidden":"true",children:"·"}),e.jsx("span",{className:"ap-topbar-tag",children:"Risk Engine™"})]})]}),e.jsxs("div",{className:"ap-topbar-center",children:[e.jsx("span",{className:"ap-topbar-clock",children:Ha(s)}),Re&&e.jsxs("span",{className:"ap-topbar-aid",children:[" · #",Re]})]}),e.jsxs("div",{className:"ap-topbar-right",children:[Fe!==null&&e.jsx("div",{className:"ap-credits-wrap",title:"Créditos restantes",children:e.jsx("div",{className:"ap-credits-bar",children:e.jsx("div",{className:"ap-credits-fill",style:{width:`${Math.max(0,Fe/20*100)}%`}})})}),e.jsxs("div",{className:"ap-engine-live",children:[e.jsx("span",{className:"ap-live-dot","aria-hidden":"true"}),e.jsx("span",{className:"ap-live-lbl",children:"IA ONLINE"})]})]})]})}),e.jsxs("div",{className:"ap-body",children:[e.jsxs("nav",{className:`ap-sidebar${c?" ap-sidebar-open":""}`,"aria-label":"Navegação",children:[e.jsxs("div",{className:"ap-sidebar-brand",children:[e.jsx("div",{className:"ap-sidebar-brand-mark","aria-hidden":"true",children:e.jsx("svg",{width:"9",height:"9",viewBox:"0 0 14 14",fill:"none",children:e.jsx("path",{d:"M7 1L13 4V10L7 13L1 10V4L7 1Z",fill:"#22C55E"})})}),e.jsx("span",{className:"ap-sidebar-brand-name",children:"MotorIA Pro"})]}),e.jsx("div",{className:"ap-sidebar-divider",role:"separator"}),Ia.map(({group:a,items:r})=>e.jsxs("div",{className:"ap-sidebar-group",children:[e.jsx("div",{className:"ap-sidebar-group-lbl",children:a}),r.map(({id:d,label:j,Icon:t,badge:p,live:k,dim:S,manual:v})=>e.jsxs("button",{className:`ap-nav-item${u===d?" ap-nav-active":""}${S?" ap-nav-dim":""}${v?" ap-nav-manual":""}`,onClick:()=>y(d),"aria-current":u===d?"page":void 0,children:[e.jsx("span",{className:"ap-nav-icon",children:e.jsx(t,{})}),e.jsx("span",{className:"ap-nav-label",children:j}),k&&e.jsx("span",{className:"ap-nav-live-dot","aria-label":"ao vivo"}),p>0&&!k&&e.jsx("span",{className:"ap-nav-badge","aria-label":`${p} itens`,children:p}),S&&!k&&e.jsx("span",{className:"ap-nav-soon","aria-label":"em breve",children:e.jsxs("svg",{width:"8",height:"8",viewBox:"0 0 10 10",fill:"none",children:[e.jsx("path",{d:"M5 2v3.5M5 7v.5",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round"}),e.jsx("circle",{cx:"5",cy:"5",r:"4",stroke:"currentColor",strokeWidth:"1.2",opacity:".5"})]})})]},d))]},a)),e.jsxs("div",{className:"ap-sidebar-engine",children:[e.jsx("div",{className:"ap-sidebar-engine-dot","aria-hidden":"true"}),e.jsxs("div",{className:"ap-sidebar-engine-info",children:[e.jsx("span",{className:"ap-sidebar-engine-name",children:"RISK ENGINE v2.4"}),e.jsx("span",{className:"ap-sidebar-engine-status",children:"ONLINE"})]})]})]}),e.jsxs("main",{className:"ap-main",children:[u==="geral"&&e.jsxs("div",{className:"ap-content",children:[e.jsxs("div",{className:"ap-panel-hdr",children:[e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:"MÓDULO I"}),e.jsx("div",{className:"ap-panel-title",children:"Visão Geral"})]}),e.jsxs("div",{className:"ap-panel-online",children:[e.jsx("span",{className:"ap-status-dot","aria-hidden":"true"}),"SISTEMA ONLINE"]})]}),e.jsxs("div",{className:"ap-geral-stats",children:[e.jsxs("div",{className:"ap-geral-stat",children:[e.jsx("div",{className:"ap-geral-stat-val",children:z.length}),e.jsx("div",{className:"ap-geral-stat-lbl",children:"ANÁLISES"})]}),e.jsxs("div",{className:"ap-geral-stat",children:[e.jsx("div",{className:"ap-geral-stat-val",style:{color:X!==null?X>60?"#EF4444":X>40?"#F59E0B":"#22C55E":"var(--t3)"},children:X!==null?X:"—"}),e.jsx("div",{className:"ap-geral-stat-lbl",children:"SCORE MÉDIO"})]}),e.jsxs("div",{className:"ap-geral-stat",children:[e.jsx("div",{className:"ap-geral-stat-val",children:Ge?Ge.odd.toFixed(2):"—"}),e.jsx("div",{className:"ap-geral-stat-lbl",children:"ÚLTIMA ODD"})]}),e.jsxs("div",{className:"ap-geral-stat",children:[e.jsx("div",{className:"ap-geral-stat-val ap-geral-stat-val-sm",children:"v2.4"}),e.jsx("div",{className:"ap-geral-stat-lbl",children:"ENGINE"})]})]}),e.jsxs("div",{className:"ap-geral-action",children:[e.jsxs("div",{className:"ap-geral-action-left",children:[e.jsx("div",{className:"ap-geral-action-title",children:"Iniciar nova análise quantitativa"}),e.jsx("div",{className:"ap-geral-action-sub",children:"MOTORIA RISK INDEX™ · Probabilidade · EV · Exposição"})]}),e.jsxs("button",{className:"ap-geral-btn",onClick:()=>y("nova"),children:["Analisar",e.jsx("svg",{width:"11",height:"11",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M2.5 7H11.5M11.5 7L8 3.5M11.5 7L8 10.5",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})})]})]}),z.length>0&&e.jsxs("div",{className:"ap-geral-recent",children:[e.jsx("div",{className:"ap-geral-recent-hdr",children:"ANÁLISES RECENTES"}),e.jsx("div",{className:"ap-geral-recent-list",children:z.slice(0,4).map((a,r)=>e.jsxs("button",{className:"ap-geral-recent-row",onClick:()=>Ke(a),children:[e.jsxs("span",{className:"ap-geral-recent-id",children:["#",a.id]}),e.jsx("span",{className:"ap-geral-recent-event",children:a.jogo||"Aposta"}),e.jsxs("span",{className:"ap-geral-recent-odd",children:["Odd ",a.odd]}),e.jsx("div",{className:"ap-geral-recent-bar",children:e.jsx("div",{style:{width:`${a.score}%`,background:a.color,height:"100%",borderRadius:99}})}),e.jsx("span",{className:"ap-geral-recent-score",style:{color:a.color},children:a.score}),e.jsx("span",{className:"ap-geral-recent-tag",style:{color:a.color},children:a.label})]},r))})]}),z.length===0&&e.jsxs("div",{className:"ap-geral-empty",children:[e.jsx("p",{children:"Nenhuma análise registrada ainda."}),e.jsx("button",{className:"ap-geral-btn",onClick:()=>y("nova"),children:"Iniciar primeira análise →"})]})]},"geral"),u==="nova"&&e.jsxs("div",{className:"ap-content ap-content-nova",children:[l&&!h&&!M&&e.jsxs("div",{className:`ap-game-strip${l.status==="live"?" ap-game-strip-live":""}`,children:[e.jsx("span",{className:`ap-game-strip-dot${l.status==="live"?" ap-gsd-live":""}`,"aria-hidden":"true"}),e.jsxs("span",{className:"ap-game-strip-text",children:[l.home," × ",l.away]}),l.campeonato&&e.jsx("span",{className:"ap-game-strip-league",children:l.campeonato}),l.status==="live"?e.jsxs("span",{className:"ap-gsd-live-badge",children:["AO VIVO",l.elapsed?` · ${l.elapsed}'`:""]}):l.time?e.jsx("span",{className:"ap-game-strip-time",children:l.time}):null,e.jsx("button",{className:"ap-game-strip-clear",onClick:()=>{Z(null),D(""),_("")},"aria-label":"Remover jogo selecionado",type:"button",children:"×"})]}),!h&&!M&&e.jsx("section",{className:"ap-input-panel",children:e.jsxs("form",{className:"ap-form",onSubmit:ya,noValidate:!0,children:[e.jsxs("div",{className:"ap-row-2",children:[e.jsxs("div",{className:"ap-field",children:[e.jsx("label",{className:"ap-label",htmlFor:"odd-input",children:"ODD"}),e.jsx("input",{id:"odd-input",className:"ap-input ap-input-odd",type:"text",placeholder:"2.80",value:B,onChange:a=>J(a.target.value),inputMode:"decimal",autoComplete:"off"}),ye&&e.jsxs("div",{className:"ap-odd-preview",style:{color:ye.color},children:[e.jsx("span",{children:ye.label}),e.jsx("span",{className:"ap-odd-preview-sep",children:"·"}),e.jsxs("span",{children:["chance ",Le(le).toFixed(0),"%"]})]})]}),e.jsxs("div",{className:"ap-field",children:[e.jsx("label",{className:"ap-label",htmlFor:"valor-input",children:"QUANTO VAI APOSTAR?"}),e.jsx("input",{id:"valor-input",className:"ap-input",type:"text",placeholder:"R$ 100",value:be,onChange:a=>Ie(a.target.value),inputMode:"decimal",autoComplete:"off"})]})]}),e.jsxs("div",{className:"ap-field",children:[e.jsx("label",{className:"ap-label",htmlFor:"tipo-input",children:"TIPO DE APOSTA"}),e.jsx(na,{id:"tipo-input",options:Ra,value:w,onChange:W})]}),l&&Se[w]&&!B&&e.jsxs("div",{className:"ap-odd-sug",children:[e.jsx("span",{className:"ap-odd-sug-icon","aria-hidden":"true",children:"💡"}),e.jsxs("span",{className:"ap-odd-sug-text",children:["Odd referência para ",e.jsx("em",{children:w}),":"," ",e.jsx("strong",{children:Se[w]})]}),e.jsx("button",{type:"button",className:"ap-odd-sug-btn",onClick:()=>J(Se[w]),children:"Usar"})]}),e.jsxs("div",{className:"ap-row-2 ap-row-secondary",children:[e.jsxs("div",{className:"ap-field",children:[e.jsx("label",{className:"ap-label ap-label-dim",htmlFor:"camp-input",children:"CAMPEONATO"}),e.jsx(na,{id:"camp-input",options:Da,value:U,onChange:_,placeholder:"Selecionar"})]}),e.jsxs("div",{className:"ap-field",children:[e.jsx("label",{className:"ap-label ap-label-dim",htmlFor:"jogo-input",children:"PARTIDA"}),e.jsx("input",{id:"jogo-input",className:"ap-input",type:"text",placeholder:"Ex: Flamengo × Palmeiras",value:G,onChange:a=>D(a.target.value),autoComplete:"off"})]})]}),se&&e.jsx("div",{className:"ap-error",role:"alert",children:se}),e.jsx("button",{className:"ap-submit",type:"submit",children:"INICIAR ANÁLISE →"})]})}),M&&e.jsxs("div",{className:"ap-loading",role:"status","aria-live":"polite",children:[e.jsxs("div",{className:"ap-loading-hdr",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"ap-loading-engine",children:["RISK ENGINE v2.4",e.jsx("span",{className:"ap-loading-engine-dot","aria-hidden":"true"})]}),l?e.jsxs("div",{className:"ap-loading-sub ap-loading-sub-game",children:[l.home," × ",l.away]}):e.jsx("div",{className:"ap-loading-sub",children:"Processamento quantitativo em execução"})]}),e.jsx("span",{className:"ap-loading-status",children:"CALCULANDO"})]}),e.jsxs("div",{className:"ap-loading-bar-wrap",children:[e.jsx("div",{className:"ap-loading-bar",style:{width:`${$}%`}}),e.jsx("div",{className:"ap-loading-bar-glow",style:{left:`${$}%`}})]}),e.jsxs("div",{className:"ap-loading-pct","aria-label":`${$}%`,children:[$,e.jsx("span",{className:"ap-loading-pct-sym",children:"%"})]}),e.jsx("div",{className:"ap-loading-steps",children:te.map((a,r)=>e.jsxs("div",{className:`ap-lstep${r<C?" ap-lstep-done":r===C?" ap-lstep-active":""}`,children:[e.jsx("span",{className:"ap-lstep-icon","aria-hidden":"true",children:r<C?"✓":r===C?"▶":"○"}),e.jsx("span",{className:"ap-lstep-lbl",children:a.label}),r===C&&e.jsx("span",{className:"ap-lstep-cursor","aria-hidden":"true",children:"_"}),r<C&&e.jsx("span",{className:"ap-lstep-done-tag",children:"OK"})]},r))})]}),h&&!M&&h.locked&&Ze(h.signals||[]),h&&!M&&!h.locked&&e.jsxs("div",{className:"db-output",role:"region","aria-label":"Resultado da análise",children:[e.jsxs("div",{className:"db-topbar",children:[e.jsxs("div",{className:"db-topbar-meta",children:[e.jsxs("span",{className:"db-id",children:["#",h.id]}),e.jsx("span",{className:"db-sep","aria-hidden":"true",children:"·"}),e.jsx("span",{className:"db-ts",children:h.ts}),e.jsx("span",{className:"db-sep","aria-hidden":"true",children:"·"}),e.jsxs("span",{className:"db-ai-badge",children:[e.jsx("span",{className:"db-ai-dot","aria-hidden":"true"}),"IA ativa"]})]}),e.jsx("button",{className:"db-btn-ghost",onClick:za,"aria-label":"Nova análise",children:"Nova análise →"})]}),Qe(h),e.jsx("p",{className:"db-disclaimer",children:"Análise educativa. Não representa garantia de resultado. A decisão é sua."})]})]},"nova"),u==="comparador"&&e.jsx(Oe,{mod:"MÓDULO III",title:"Comparador de Odds",desc:"Compare múltiplas odds simultaneamente e identifique distorções entre casas de apostas. O Comparador cruza probabilidades implícitas em tempo real."}),u==="aovivo"&&e.jsx(Oe,{mod:"MERCADOS",title:"Ao Vivo",desc:"Feed de análises em tempo real com atualizações automáticas de probabilidade para eventos em andamento. Integração com dados de mercado ao vivo."}),u==="favoritos"&&e.jsx(Oe,{mod:"ARQUIVO",title:"Favoritos",desc:"Salve e organize suas análises mais relevantes. Crie coleções por campeonato, mercado ou período para consulta rápida."}),u==="jogos"&&e.jsxs("div",{className:"ap-content ap-content-flow",children:[f==="lista"&&e.jsxs("div",{className:"fl-step",children:[e.jsxs("div",{className:"ap-panel-hdr",children:[e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:"ANÁLISE ESPORTIVA"}),e.jsx("div",{className:"ap-panel-title",children:"Jogos de Hoje"})]}),e.jsxs("div",{className:"jg-hdr-right",children:[e.jsxs("div",{className:"jg-data-badge",children:[e.jsx("span",{className:"jg-data-dot","aria-hidden":"true"}),"DADOS ESPORTIVOS"]}),Te&&e.jsx("span",{className:"jg-updated",children:Te.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}),e.jsx("button",{className:"jg-refresh-btn",onClick:Ne,disabled:Q,title:"Atualizar",type:"button","aria-label":"Atualizar partidas",children:e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M12 7A5 5 0 1 1 7 2M12 7V2.5M12 2.5H8",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})]})]}),Q&&e.jsxs("div",{className:"jg-loading",children:[e.jsx("span",{className:"jg-dot"}),e.jsx("span",{className:"jg-dot"}),e.jsx("span",{className:"jg-dot"}),e.jsx("span",{className:"jg-loading-lbl",children:"Atualizando jogos reais…"})]}),ve&&!Q&&e.jsxs("div",{className:"ap-geral-empty",role:"alert",children:[e.jsx("div",{className:"jg-empty-icon","aria-hidden":"true",children:e.jsxs("svg",{width:"28",height:"28",viewBox:"0 0 24 24",fill:"none",children:[e.jsx("circle",{cx:"12",cy:"12",r:"9.5",stroke:"currentColor",strokeWidth:"1.4"}),e.jsx("path",{d:"M12 7v5.5M12 15.5v.5",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round"})]})}),e.jsx("p",{className:"jg-empty-title",children:"Não conseguimos atualizar os jogos."}),e.jsx("p",{className:"jg-empty-sub",children:"Você pode tentar novamente ou fazer uma análise manual."}),e.jsxs("div",{className:"jg-empty-actions",children:[e.jsx("button",{className:"jg-retry-btn",onClick:Ne,type:"button",children:"Tentar novamente"}),e.jsx("button",{className:"ap-geral-btn",onClick:()=>y("nova"),type:"button",children:"Analisar manualmente"})]})]}),!Q&&T.length===0&&!ve&&e.jsxs("div",{className:"ap-geral-empty",children:[e.jsx("div",{className:"jg-empty-icon","aria-hidden":"true",children:e.jsxs("svg",{width:"28",height:"28",viewBox:"0 0 24 24",fill:"none",children:[e.jsx("rect",{x:"3",y:"4",width:"18",height:"17",rx:"2.5",stroke:"currentColor",strokeWidth:"1.4"}),e.jsx("path",{d:"M3 9h18M8 2v4M16 2v4",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round"}),e.jsx("path",{d:"M7.5 14h9M7.5 17.5h5.5",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round"})]})}),e.jsx("p",{className:"jg-empty-title",children:"Nenhum jogo real encontrado agora."}),e.jsx("p",{className:"jg-empty-sub",children:"Os jogos aparecem aqui quando a API retorna partidas disponíveis para hoje."}),e.jsx("button",{className:"ap-geral-btn",onClick:()=>y("nova"),type:"button",children:"Analisar manualmente →"})]}),!Q&&T.length>0&&(()=>{const a=T.filter(t=>t.status==="live").length,r=[...new Set(T.map(t=>he(t.league)).filter(Boolean))],d=["todos",...a>0?["live"]:[],...r],j=oe==="todos"?T:oe==="live"?T.filter(t=>t.status==="live"):T.filter(t=>he(t.league)===oe);return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"jg-filters",children:d.map(t=>e.jsx("button",{className:["jg-pill",oe===t?"jg-pill-on":"",t==="live"?"jg-pill-live":""].join(" ").trim(),onClick:()=>va(t),type:"button",children:t==="todos"?"Todos":t==="live"?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"jg-pill-dot","aria-hidden":"true"}),"Ao Vivo (",a,")"]}):t},t))}),e.jsx("div",{className:"jg-grid",children:j.map((t,p)=>{const k=t.scoreHome!==null&&t.scoreAway!==null;return e.jsxs("button",{className:`jg-card jg-card-${t.status}`,onClick:()=>Ca(t),type:"button",style:{animationDelay:`${Math.min(p,6)*40}ms`},children:[e.jsxs("div",{className:"jg-card-header",children:[e.jsx("span",{className:"jg-league",children:he(t.league)||t.league}),t.status==="upcoming"&&t.time&&e.jsx("span",{className:"jg-time",children:t.time})]}),t.status==="live"&&e.jsxs("div",{className:"jg-status-row",children:[e.jsx("span",{className:"jg-live-dot","aria-hidden":"true"}),e.jsx("span",{className:"jg-status-live-text",children:"AO VIVO"}),t.elapsed!=null&&e.jsxs("span",{className:"jg-elapsed",children:[t.elapsed,"'"]})]}),t.status==="ended"&&e.jsx("div",{className:"jg-status-row",children:e.jsx("span",{className:"jg-status-ended-text",children:"ENCERRADO"})}),e.jsxs("div",{className:"jg-matchup",children:[e.jsx("span",{className:"jg-team-name",children:t.home}),e.jsx("div",{className:"jg-score-center",children:k?e.jsxs("span",{className:"jg-score-pair",children:[e.jsx("span",{className:"jg-score-num",children:t.scoreHome}),e.jsx("span",{className:"jg-score-dash",children:"—"}),e.jsx("span",{className:"jg-score-num",children:t.scoreAway})]}):e.jsx("span",{className:"jg-vs",children:"×"})}),e.jsx("span",{className:"jg-team-name jg-team-right",children:t.away})]}),F&&(()=>{const S=me(t.home,F),v=me(t.away,F);if(!S&&!v)return null;const E=b=>b==="W"?"#22C55E":b==="D"?"#F59E0B":"#EF4444";return e.jsxs("div",{className:"jg-forma-row",children:[e.jsx("div",{className:"jg-forma-side",children:(S?.forma||[]).map((b,N)=>e.jsx("span",{className:"jg-forma-dot",style:{background:E(b)},title:b},N))}),e.jsx("div",{className:"jg-forma-mid"}),e.jsx("div",{className:"jg-forma-side jg-forma-side-r",children:(v?.forma||[]).map((b,N)=>e.jsx("span",{className:"jg-forma-dot",style:{background:E(b)},title:b},N))})]})})(),e.jsx("div",{className:"jg-card-footer",children:e.jsx("span",{className:"jg-cta",children:"Vale apostar? →"})})]},t.id||p)})}),e.jsxs("div",{className:"jg-disclaimer",role:"note",children:[e.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("circle",{cx:"7",cy:"7",r:"5.5",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M7 6.5v3.5M7 4.5v.5",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round"})]}),"Ferramenta educativa. Dados de partidas para contexto de análise de risco. Não é recomendação de aposta."]})]})})()]}),f==="mercado"&&l&&e.jsxs("div",{className:"fl-step",children:[e.jsxs("button",{className:"fl-back-btn",onClick:()=>{Z(null),m("lista")},type:"button",children:[e.jsx("svg",{width:"10",height:"10",viewBox:"0 0 12 12",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M8 2L4 6L8 10",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})}),"Mudar partida"]}),e.jsxs("div",{className:`fl-game-hero${l.status==="live"?" fl-game-hero-live":""}`,children:[e.jsxs("div",{className:"fl-hero-meta",children:[e.jsx("span",{className:"fl-hero-league",children:l.campeonato}),l.status==="live"?e.jsxs("div",{className:"fl-hero-status-live",children:[e.jsx("span",{className:"fl-hero-live-dot","aria-hidden":"true"}),"AO VIVO",l.elapsed?` · ${l.elapsed}'`:""]}):l.time?e.jsx("span",{className:"fl-hero-time",children:l.time}):null]}),e.jsxs("div",{className:"fl-teams",children:[e.jsx("span",{className:"fl-team",children:l.home}),e.jsx("span",{className:"fl-vs",children:"×"}),e.jsx("span",{className:"fl-team fl-team-right",children:l.away})]})]}),e.jsx("div",{className:"fl-section-hdr",children:"ESCOLHA O MERCADO"}),e.jsx("div",{className:"fl-market-list",children:aa.map(a=>{const r=Na?.tipo===a.tipo;return e.jsxs("div",{className:`fl-mcard${r?" fl-mcard-open":""}`,children:[e.jsxs("button",{className:"fl-mcard-hdr",onClick:()=>{r?(we(null),ne("")):(we(a),ne(a.ref))},type:"button",children:[e.jsx("span",{className:"fl-mcard-name",children:a.tipo}),e.jsxs("span",{className:"fl-mcard-ref",children:["Ref. ",a.ref]}),e.jsx("svg",{className:"fl-mcard-chev",width:"10",height:"10",viewBox:"0 0 12 12",fill:"none",style:{transform:r?"rotate(180deg)":"none"},children:e.jsx("path",{d:"M2.5 4.5L6 8L9.5 4.5",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})})]}),r&&e.jsxs("div",{className:"fl-mcard-body",children:[e.jsx("span",{className:"fl-mcard-odd-lbl",children:"Sua odd"}),e.jsx("input",{className:"fl-mcard-odd-input",type:"text",value:Ye,onChange:d=>ne(d.target.value),placeholder:a.ref,inputMode:"decimal",autoComplete:"off",autoFocus:!0,"aria-label":"Informe a odd"}),e.jsx("button",{className:"fl-mcard-confirm",onClick:()=>Je(a.tipo,Ye||a.ref),type:"button",children:"Analisar →"})]})]},a.tipo)})}),e.jsx("button",{className:"fl-manual-link",onClick:()=>y("nova"),type:"button",children:"Abrir análise manual completa →"})]}),f==="resultado"&&e.jsxs("div",{className:"fl-step",children:[l&&e.jsxs("div",{className:`fl-ctx-strip${l.status==="live"?" fl-ctx-live":""}`,children:[e.jsx("span",{className:"fl-ctx-dot","aria-hidden":"true"}),e.jsxs("span",{className:"fl-ctx-match",children:[l.home," × ",l.away]}),e.jsx("span",{className:"fl-ctx-sep","aria-hidden":"true",children:"·"}),e.jsx("span",{className:"fl-ctx-tipo",children:w}),l.status==="live"&&e.jsx("span",{className:"fl-ctx-live-badge",children:"AO VIVO"})]}),M&&e.jsxs("div",{className:"ap-loading",role:"status","aria-live":"polite",children:[e.jsxs("div",{className:"ap-loading-hdr",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"ap-loading-engine",children:["RISK ENGINE v2.4",e.jsx("span",{className:"ap-loading-engine-dot","aria-hidden":"true"})]}),e.jsx("div",{className:"ap-loading-sub ap-loading-sub-game",children:l?`${l.home} × ${l.away}`:"Processando análise"})]}),e.jsx("span",{className:"ap-loading-status",children:"CALCULANDO"})]}),e.jsxs("div",{className:"ap-loading-bar-wrap",children:[e.jsx("div",{className:"ap-loading-bar",style:{width:`${$}%`}}),e.jsx("div",{className:"ap-loading-bar-glow",style:{left:`${$}%`}})]}),e.jsxs("div",{className:"ap-loading-pct","aria-label":`${$}%`,children:[$,e.jsx("span",{className:"ap-loading-pct-sym",children:"%"})]}),e.jsx("div",{className:"ap-loading-steps",children:te.map((a,r)=>e.jsxs("div",{className:`ap-lstep${r<C?" ap-lstep-done":r===C?" ap-lstep-active":""}`,children:[e.jsx("span",{className:"ap-lstep-icon","aria-hidden":"true",children:r<C?"✓":r===C?"▶":"○"}),e.jsx("span",{className:"ap-lstep-lbl",children:a.label}),r===C&&e.jsx("span",{className:"ap-lstep-cursor","aria-hidden":"true",children:"_"}),r<C&&e.jsx("span",{className:"ap-lstep-done-tag",children:"OK"})]},r))})]}),se&&!M&&e.jsxs("div",{className:"ap-error",role:"alert",children:[se,e.jsx("button",{className:"fl-retry",onClick:()=>{O(""),Je(w,B)},type:"button",children:"Tentar novamente"})]}),h&&!M&&h.locked&&Ze(h.signals||[]),h&&!M&&!h.locked&&e.jsxs("div",{className:"db-output",role:"region","aria-label":"Resultado da análise",children:[e.jsxs("div",{className:"db-topbar",children:[e.jsxs("div",{className:"db-topbar-meta",children:[e.jsxs("span",{className:"db-id",children:["#",h.id]}),e.jsx("span",{className:"db-sep","aria-hidden":"true",children:"·"}),e.jsx("span",{className:"db-ts",children:h.ts}),e.jsx("span",{className:"db-sep","aria-hidden":"true",children:"·"}),e.jsxs("span",{className:"db-ai-badge",children:[e.jsx("span",{className:"db-ai-dot","aria-hidden":"true"}),"IA ativa"]})]}),e.jsx("div",{className:"fl-result-nav",children:e.jsx("button",{className:"db-btn-ghost",onClick:()=>{L(null),O(""),m("mercado")},type:"button",children:"← Outro mercado"})})]}),Qe(h),F&&h.jogo&&h.jogo!=="Aposta"&&(()=>{const a=h.jogo.split(" × ");if(a.length!==2)return null;const r=sa(a[0].trim(),a[1].trim(),F);if(!r)return null;const d=r.h+r.d+r.a,j=a[0].trim().split(" ")[0],t=a[1].trim().split(" ")[0];return e.jsxs("div",{className:"db-h2h",children:[e.jsxs("div",{className:"db-h2h-title",children:["H2H · Últimos ",d," jogos"]}),e.jsxs("div",{className:"db-h2h-row",children:[e.jsxs("div",{className:"db-h2h-item",children:[e.jsx("span",{className:"db-h2h-val",style:{color:"#22C55E"},children:r.h}),e.jsx("span",{className:"db-h2h-lbl",children:j})]}),e.jsxs("div",{className:"db-h2h-item",children:[e.jsx("span",{className:"db-h2h-val",children:r.d}),e.jsx("span",{className:"db-h2h-lbl",children:"Empate"})]}),e.jsxs("div",{className:"db-h2h-item",children:[e.jsx("span",{className:"db-h2h-val",style:{color:"#EF4444"},children:r.a}),e.jsx("span",{className:"db-h2h-lbl",children:t})]}),e.jsxs("div",{className:"db-h2h-item",children:[e.jsx("span",{className:"db-h2h-val",style:{color:"#F59E0B"},children:r.mediaGols}),e.jsx("span",{className:"db-h2h-lbl",children:"Méd. gols"})]})]})]})})(),aa.some(a=>a.ref===h.odd.toFixed(2))&&e.jsxs("div",{className:"fl-ref-note",children:["Análise com odd de referência (",h.odd.toFixed(2),"). Use a odd real da sua casa para maior precisão."]}),e.jsx("div",{className:"db-actions",children:e.jsxs("button",{className:"db-btn-primary",onClick:()=>{L(null),O(""),Z(null),m("lista")},type:"button",children:[e.jsx("svg",{width:"11",height:"11",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M2.5 7H11.5M11.5 7L8 3.5M11.5 7L8 10.5",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})}),"Nova partida"]})}),e.jsx("p",{className:"db-disclaimer",children:"Análise educativa. Não representa garantia de resultado. A decisão é sempre sua."})]})]})]},`jogos-${f}`),u==="banca"&&(()=>{const a=parseFloat(ja?.bancaInicial)||0,r=a>0?ca(V,a):null,d=a>0?Ja(V,a):[],j=r?(r.saldo/a*100).toFixed(1):null;return e.jsxs("div",{className:"ap-content",children:[e.jsxs("div",{className:"ap-panel-hdr",children:[e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:"GESTÃO"}),e.jsx("div",{className:"ap-panel-title",children:"Controle de Banca"})]}),e.jsxs("div",{className:"ap-panel-online",children:[e.jsx("span",{className:"ap-status-dot","aria-hidden":"true"}),V.length," ENTRADAS"]})]}),La?e.jsxs(e.Fragment,{children:[!a&&e.jsxs("div",{className:"bk-setup-panel",children:[e.jsx("div",{className:"bk-setup-title",children:"Configure sua banca inicial"}),e.jsx("div",{className:"bk-setup-sub",children:"Informe o valor total que você dedica às apostas para calcular métricas precisas."}),e.jsxs("div",{className:"bk-setup-row",children:[e.jsx("span",{className:"bk-currency",children:"R$"}),e.jsx("input",{className:"ap-input bk-setup-input",type:"number",min:"1",step:"0.01",placeholder:"Ex: 500.00",value:_e,onChange:t=>He(t.target.value),onKeyDown:t=>t.key==="Enter"&&qe()}),e.jsx("button",{className:"bk-setup-btn",onClick:qe,children:"Confirmar"})]})]}),d.length>0&&e.jsx("div",{className:"bk-alerts",children:d.map((t,p)=>e.jsxs("div",{className:`bk-alert bk-alert-${t.type}`,children:[e.jsx("span",{className:"bk-alert-icon",children:t.type==="danger"?"⚠":"●"}),t.msg]},p))}),a>0&&r&&e.jsxs("div",{className:"bk-cards",children:[e.jsxs("div",{className:"bk-card",children:[e.jsx("div",{className:"bk-card-label",children:"SALDO ATUAL"}),e.jsxs("div",{className:"bk-card-val",style:{color:r.saldo>=a?"var(--green)":"var(--red)"},children:["R$ ",r.saldo.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})]}),e.jsxs("div",{className:"bk-card-sub",children:[j,"% da banca inicial"]})]}),e.jsxs("div",{className:"bk-card",children:[e.jsx("div",{className:"bk-card-label",children:"LUCRO / PREJUÍZO"}),e.jsxs("div",{className:"bk-card-val",style:{color:r.lucroTotal>=0?"var(--green)":"var(--red)"},children:[r.lucroTotal>=0?"+":"","R$ ",Math.abs(r.lucroTotal).toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})]}),e.jsxs("div",{className:"bk-card-sub",children:[r.wins,"G · ",r.losses,"P de ",r.totalApos," apostas"]})]}),e.jsxs("div",{className:"bk-card",children:[e.jsx("div",{className:"bk-card-label",children:"ROI"}),e.jsxs("div",{className:"bk-card-val",style:{color:r.roi>=0?"var(--green)":"var(--red)"},children:[r.roi>=0?"+":"",r.roi.toFixed(1),"%"]}),e.jsx("div",{className:"bk-card-sub",children:"Retorno sobre investido"})]}),e.jsxs("div",{className:"bk-card",children:[e.jsx("div",{className:"bk-card-label",children:"TAXA DE ACERTO"}),e.jsxs("div",{className:"bk-card-val",style:{color:r.acerto>=55?"var(--green)":r.acerto>=45?"var(--amber)":"var(--red)"},children:[r.acerto.toFixed(1),"%"]}),e.jsxs("div",{className:"bk-card-sub",children:[r.wins," vitórias"]})]}),e.jsxs("div",{className:"bk-card",children:[e.jsx("div",{className:"bk-card-label",children:"SEQUÊNCIA ATUAL"}),e.jsx("div",{className:"bk-card-val",style:{color:r.streak>0?"var(--green)":r.streak<0?"var(--red)":"var(--t2)"},children:r.streak>0?`+${r.streak}`:r.streak===0?"—":r.streak}),e.jsxs("div",{className:"bk-card-sub",children:["Pior sequência: ",r.maxStreak," derrotas"]})]}),e.jsxs("div",{className:"bk-card",children:[e.jsx("div",{className:"bk-card-label",children:"BANCA INICIAL"}),e.jsxs("div",{className:"bk-card-val",style:{color:"var(--t1)"},children:["R$ ",a.toLocaleString("pt-BR",{minimumFractionDigits:2,maximumFractionDigits:2})]}),e.jsx("div",{className:"bk-card-sub bk-reset-link",onClick:()=>{Ve({}),oa({})},children:"redefinir"})]})]}),e.jsxs("div",{className:"bk-actions",children:[e.jsx("button",{className:"bk-add-btn",onClick:()=>We(t=>!t),children:Pe?"Cancelar":"+ Registrar entrada"}),V.length>0&&(ka?e.jsxs("div",{className:"bk-clear-confirm",children:[e.jsx("span",{children:"Apagar tudo?"}),e.jsx("button",{className:"bk-clear-yes",onClick:Ea,children:"Sim, apagar"}),e.jsx("button",{className:"bk-clear-no",onClick:()=>ke(!1),children:"Cancelar"})]}):e.jsx("button",{className:"bk-clear-btn",onClick:()=>ke(!0),children:"Limpar histórico"}))]}),Pe&&e.jsxs("div",{className:"bk-form",children:[e.jsxs("div",{className:"bk-form-row",children:[e.jsxs("div",{className:"bk-form-field",children:[e.jsx("label",{className:"ap-label",children:"VALOR APOSTADO (R$)"}),e.jsx("input",{className:"ap-input",type:"number",min:"0.01",step:"0.01",placeholder:"Ex: 25.00",value:A.valor,onChange:t=>Y(p=>({...p,valor:t.target.value}))})]}),e.jsxs("div",{className:"bk-form-field",children:[e.jsx("label",{className:"ap-label",children:"ODD"}),e.jsx("input",{className:"ap-input",type:"number",min:"1.01",step:"0.01",placeholder:"Ex: 1.85",value:A.odd,onChange:t=>Y(p=>({...p,odd:t.target.value}))})]})]}),e.jsxs("div",{className:"bk-form-row",children:[e.jsxs("div",{className:"bk-form-field",children:[e.jsx("label",{className:"ap-label",children:"RESULTADO"}),e.jsxs("select",{className:"ap-input",value:A.resultado,onChange:t=>Y(p=>({...p,resultado:t.target.value})),children:[e.jsx("option",{children:"Ganhou"}),e.jsx("option",{children:"Perdeu"}),e.jsx("option",{children:"Anulada"})]})]}),e.jsxs("div",{className:"bk-form-field",children:[e.jsx("label",{className:"ap-label",children:"MERCADO"}),e.jsx("select",{className:"ap-input",value:A.mercado,onChange:t=>Y(p=>({...p,mercado:t.target.value})),children:Ba.map(t=>e.jsx("option",{children:t},t))})]})]}),e.jsxs("div",{className:"bk-form-field",children:[e.jsx("label",{className:"ap-label",children:"OBSERVAÇÃO (opcional)"}),e.jsx("input",{className:"ap-input",type:"text",maxLength:120,placeholder:"Ex: Flamengo × Palmeiras — aposta no empate",value:A.obs,onChange:t=>Y(p=>({...p,obs:t.target.value}))})]}),e.jsx("button",{className:"bk-submit-btn",onClick:Aa,disabled:!A.valor||!A.odd,children:"Salvar entrada"})]}),V.length>0?e.jsxs("div",{className:"bk-hist",children:[e.jsxs("div",{className:"bk-hist-hdr",children:[e.jsx("span",{children:"Data"}),e.jsx("span",{children:"Mercado"}),e.jsx("span",{children:"Odd"}),e.jsx("span",{children:"Valor"}),e.jsx("span",{children:"Resultado"}),e.jsx("span",{})]}),V.map(t=>{const p=t.resultado==="Ganhou"?"var(--green)":t.resultado==="Perdeu"?"var(--red)":"var(--t2)",k=t.resultado==="Ganhou"?`+R$ ${(t.valor*(t.odd-1)).toFixed(2)}`:t.resultado==="Perdeu"?`-R$ ${parseFloat(t.valor).toFixed(2)}`:"—";return e.jsxs("div",{className:"bk-hist-row",children:[e.jsx("span",{className:"bk-hist-date",children:new Date(t.ts).toLocaleDateString("pt-BR",{day:"2-digit",month:"2-digit"})}),e.jsx("span",{className:"bk-hist-mercado",children:t.mercado}),e.jsx("span",{className:"bk-hist-odd",children:parseFloat(t.odd).toFixed(2)}),e.jsxs("span",{className:"bk-hist-valor",children:["R$ ",parseFloat(t.valor).toFixed(2)]}),e.jsx("span",{className:"bk-hist-res",style:{color:p},children:k}),e.jsx("button",{className:"bk-hist-del",onClick:()=>Sa(t.id),"aria-label":"Remover",children:"×"})]},t.id)})]}):a>0?e.jsx("div",{className:"ap-empty",children:"Nenhuma entrada registrada. Use o botão acima para adicionar."}):null,e.jsxs("div",{className:"bk-edu",children:[e.jsx("p",{children:"A gestão de banca é o único fator que você controla totalmente em apostas. Defina um limite, respeite-o."}),e.jsx("p",{children:"Recomenda-se arriscar entre 1% e 3% da banca por entrada para preservar o capital a longo prazo."})]}),e.jsx("p",{className:"db-disclaimer",children:"Ferramenta educativa. Não representa orientação financeira. A responsabilidade pelas decisões é inteiramente sua."})]}):e.jsx("div",{className:"lk-wrap",style:{marginTop:12},children:e.jsxs("div",{className:"lk-preview-card",style:{minHeight:340},children:[e.jsxs("div",{className:"lk-header",children:[e.jsx("div",{className:"lk-header-event",children:"Controle de Banca"}),e.jsx("div",{className:"lk-header-meta",children:e.jsx("span",{className:"lk-badge-blur",children:"████████"})})]}),e.jsx("div",{className:"lk-divider"}),e.jsx("div",{className:"bk-stats-blur-row",children:["Saldo atual","ROI","Acerto","Perda máx."].map(t=>e.jsxs("div",{className:"bk-stat-blur-card",children:[e.jsx("div",{className:"bk-stat-blur-val",children:"██.█"}),e.jsx("div",{className:"bk-stat-blur-label",children:t})]},t))}),e.jsxs("div",{className:"lk-overlay",children:[e.jsx("div",{className:"lk-lock-icon",children:e.jsxs("svg",{width:"28",height:"28",viewBox:"0 0 24 24",fill:"none",children:[e.jsx("rect",{x:"3",y:"11",width:"18",height:"11",rx:"3",stroke:"rgba(255,255,255,.25)",strokeWidth:"1.5"}),e.jsx("path",{d:"M7 11V7a5 5 0 0 1 10 0v4",stroke:"rgba(255,255,255,.25)",strokeWidth:"1.5",strokeLinecap:"round"}),e.jsx("circle",{cx:"12",cy:"16",r:"1.5",fill:"rgba(255,255,255,.25)"})]})}),e.jsx("div",{className:"lk-lock-title",children:"Controle de banca disponível com acesso"}),e.jsx("div",{className:"lk-lock-sub",children:"Registre entradas · acompanhe ROI · gerencie sua banca"}),e.jsx("a",{href:ta,className:"lk-cta-btn",children:"Desbloquear acesso completo"}),e.jsx("div",{className:"lk-price-note",children:"Pagamento único · sem mensalidade · acesso imediato · R$ 27"})]})]})})]},"banca")})(),u==="historico"&&e.jsxs("div",{className:"ap-content",children:[e.jsxs("div",{className:"ap-panel-hdr",children:[e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:"ARQUIVO"}),e.jsx("div",{className:"ap-panel-title",children:"Histórico de análises"})]}),e.jsxs("div",{className:"ap-panel-online",children:[e.jsx("span",{className:"ap-status-dot","aria-hidden":"true"}),z.length," REGISTROS"]})]}),z.length===0?e.jsx("div",{className:"ap-empty",children:"Nenhuma análise registrada nesta sessão."}):e.jsx("div",{className:"ap-hist-list",children:z.map((a,r)=>e.jsxs("button",{className:"ap-hist-row",onClick:()=>Ke(a),children:[e.jsxs("span",{className:"ap-hist-id",children:["#",a.id||"—"]}),e.jsx("span",{className:"ap-hist-event",children:a.jogo||"Aposta"}),e.jsxs("span",{className:"ap-hist-odd",children:["Odd ",a.odd]}),e.jsx("div",{className:"ap-hist-bar",children:e.jsx("div",{style:{width:`${a.score}%`,background:a.color,height:"100%",borderRadius:99}})}),e.jsx("span",{className:"ap-hist-score",style:{color:a.color},children:a.score}),e.jsx("span",{className:"ap-hist-tag",style:{color:a.color,borderColor:`${a.color}33`},children:a.label}),e.jsx("span",{className:"ap-hist-ts",children:a.ts||""})]},r))})]},"historico"),u==="config"&&e.jsxs("div",{className:"ap-content",children:[e.jsx("div",{className:"ap-panel-hdr",children:e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:"SISTEMA"}),e.jsx("div",{className:"ap-panel-title",children:"Configurações"})]})}),e.jsxs("div",{className:"ap-config-panel",children:[e.jsxs("div",{className:"ap-config-field",children:[e.jsx("label",{className:"ap-label",htmlFor:"token-input",children:"TOKEN DE ACESSO"}),e.jsx("input",{id:"token-input",className:"ap-input ap-input-mono",type:"text",placeholder:"Cole seu token de acesso aqui",value:q,onChange:a=>{ue(a.target.value),localStorage.setItem(ge,a.target.value)},autoComplete:"off",spellCheck:!1}),e.jsx("p",{className:"ap-config-hint",children:"Token recebido por email após a confirmação de acesso."})]}),e.jsxs("div",{className:"ap-config-info",children:[e.jsxs("div",{className:"ap-config-row",children:[e.jsx("span",{children:"Engine"}),e.jsx("span",{children:"MotorIA Risk Engine™ v2.4"})]}),e.jsxs("div",{className:"ap-config-row",children:[e.jsx("span",{children:"Modelo"}),e.jsx("span",{children:"Quantitative Risk v2"})]}),e.jsxs("div",{className:"ap-config-row",children:[e.jsx("span",{children:"Histórico local"}),e.jsxs("span",{children:[z.length," / ",ra]})]}),e.jsxs("div",{className:"ap-config-row",children:[e.jsx("span",{children:"Status"}),e.jsx("span",{className:"ap-config-online",children:"● ONLINE"})]})]})]})]},"config")]})]})]})]})}const ir=`
