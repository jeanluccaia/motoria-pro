import{r as o,j as e}from"./vendor-BnG4zNoI.js";import{L as je}from"./landing-BVTIqeJr.js";const we=["Resultado final (1X2)","Over / Under gols","Ambas marcam (BTTS)","Handicap asiático","Handicap europeu","Chance dupla","Draw No Bet","Primeiro gol","Escanteios","Cartões","Múltipla","Outro"],b=[{label:"Calculando a chance real de ganhar…",pct:18},{label:"Detectando o corte da casa…",pct:36},{label:"Medindo o nível de perigo da aposta…",pct:56},{label:"Encontrando o que a plataforma esconde…",pct:76},{label:"Preparando sua análise completa…",pct:92}],v="motoria_token",ie="motoria_hist_v2",ye=8,B="https://pay.kiwify.com.br/DIVD8zl";function se(r){return 1/r*100}function Ne(r){return r<=1.4?4:r<=1.7?4.8:r<=2.2?5.5:r<=3?6.5:8}function ke(r,n){return r/100*(n-1)*100-(1-r/100)*100}function ze(r){return r>60?{label:"ALTA",color:"#FF4D2E"}:r>42?{label:"MÉDIA",color:"#FFB020"}:{label:"BAIXA",color:"#1FCB7A"}}function ae(r){const n=Math.min(100,Math.round(100-se(r)));let i,x;return n<=30?(i="BAIXO",x="#1FCB7A"):n<=60?(i="MODERADO",x="#FFB020"):n<=80?(i="ALTO",x="#FF6B2E"):(i="CRÍTICO",x="#FF4D2E"),{score:n,label:i,color:x}}function Ee(r,n){const i=r.match(new RegExp(`^${n}:\\s*(.+)`,"m"));return i?i[1].trim():null}function N(r,n){const i=r.match(new RegExp(`^${n}:[^\\n]*\\n([\\s\\S]*?)(?=\\n[A-Z_]{3,}:|$)`,"m"));return i?i[1].trim():Ee(r,n)}function Re(r){return{riscoPrincipal:N(r,"RISCO_PRINCIPAL"),cenarioNecessario:N(r,"CENARIO_NECESSARIO"),oQuePodeDarErrado:N(r,"O_QUE_PODE_DAR_ERRADO"),leituraConservadora:N(r,"LEITURA_CONSERVADORA"),alertaFinal:N(r,"ALERTA_FINAL")}}function oe(){return new Date().toLocaleString("pt-BR",{day:"2-digit",month:"2-digit",hour:"2-digit",minute:"2-digit"}).replace(",","")}function Ae(){try{return JSON.parse(localStorage.getItem(ie)||"[]")}catch{return[]}}function le(r){try{localStorage.setItem(ie,JSON.stringify(r))}catch{}}function Oe(){const[r,n]=o.useState(""),[i,x]=o.useState("Resultado final (1X2)"),[k,V]=o.useState(""),[C,$]=o.useState(""),[S,q]=o.useState(""),[d,I]=o.useState(!1),[O,H]=o.useState(0),[F,L]=o.useState(0),[U,j]=o.useState(""),[a,T]=o.useState(null),[X,Y]=o.useState(Ae),[w,z]=o.useState(()=>localStorage.getItem(v)||""),[g,y]=o.useState(null),[ne,Q]=o.useState(0),[h,E]=o.useState(null),[W,de]=o.useState(""),[D,J]=o.useState(!1),[M,f]=o.useState(""),K=o.useRef(null),Z=o.useRef(null);o.useRef(null),o.useEffect(()=>{const t=localStorage.getItem(v);t&&G(t,!1)},[]);async function G(t,l=!0){try{const p=await fetch("/api/validate-token",{headers:{Authorization:`Bearer ${t}`}}),m=await p.json();if(p.ok&&m.valid)return z(t),y(m.credits),localStorage.setItem(v,t),E(null),f(""),!0;{const u=m.code==="TOKEN_EXPIRED"?"Seu token expirou. Adquira um novo pacote para continuar.":"Token inválido ou não encontrado.";return l&&f(u),localStorage.removeItem(v),z(""),!1}}catch{return l&&f("Erro de conexão ao validar token."),!1}}async function ce(t){t.preventDefault();const l=W.trim();if(!l){f("Digite seu código de acesso.");return}J(!0),f("");const p=await G(l,!0);J(!1),!p&&!M&&f("Token inválido ou não encontrado.")}function pe(){localStorage.removeItem(v),z(""),y(null),E(null)}function xe(){let t=0;H(0),L(b[0].pct),Z.current=setInterval(()=>{t=Math.min(t+1,b.length-1),H(t),L(b[t].pct)},1300)}function ee(){clearInterval(Z.current),L(100)}async function ge(t){if(t.preventDefault(),j(""),T(null),!r.trim()){j("Informe o jogo ou evento.");return}const l=parseFloat(k.replace(",","."));if(!k.trim()||isNaN(l)||l<=1){j("Informe uma odd válida — número maior que 1 (ex: 1.80).");return}const p=se(l),m=[`Jogo: ${r.trim()}`,`Tipo de aposta: ${i}`,`Odd: ${k.trim()}`,`Probabilidade implícita: ${p.toFixed(1)}%`];C.trim()&&m.push(`Valor pretendido: R$ ${C.trim()}`),S.trim()&&m.push(`Contexto adicional: ${S.trim()}`),I(!0),xe();try{const u={"Content-Type":"application/json"};w&&(u.Authorization=`Bearer ${w}`);const A=await fetch("/api/chat",{method:"POST",headers:u,body:JSON.stringify({tool:"chance_de_perder",userMessage:m.join(`
`)})}),c=await A.json();if(A.status===402){c.code==="NO_CREDITS"?(y(0),E("no_credits")):c.code==="FREE_LIMIT"&&(Q(c.freeUsed??2),E("free_limit")),ee(),I(!1);return}if(A.status===401){localStorage.removeItem(v),z(""),y(null);const P=c.code==="TOKEN_EXPIRED"?"Seu token expirou. Adquira um novo pacote.":"Sessão inválida. Insira seu token novamente.";throw new Error(P)}if(!A.ok)throw new Error(c.error||"Erro ao processar. Tente novamente.");c.credits!=null&&y(c.credits),c.freeUsed!=null&&Q(c.freeUsed);const fe=c.content?.[0]?.text||"",ue=Ne(l),be=ke(p,l),ve={ai:Re(fe),oddN:l,prob:p,vig:ue,ev:be};T(ve);const _=ae(l);Y(P=>{const re=[{id:Date.now(),jogo:r.trim(),tipo:i,odd:l,score:_.score,label:_.label,color:_.color,date:oe()},...P].slice(0,ye);return le(re),re}),setTimeout(()=>K.current?.scrollIntoView({behavior:"smooth",block:"start"}),200)}catch(u){j(u.message||"Erro de conexão. Verifique sua internet.")}finally{ee(),I(!1)}}function me(){T(null),j(""),V(""),q(""),$(""),window.scrollTo({top:0,behavior:"smooth"})}const R=a?ze(100-a.prob):null,s=a?ae(a.oddN):null,te=(a?.ai.oQuePodeDarErrado||"").split(`
`).filter(t=>t.trim()).map(t=>t.replace(/^[-•*]\s*/,"")),he=Math.max(0,2-ne);return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:Ce}),e.jsxs("header",{className:"tl-header",children:[e.jsx("div",{className:"tl-header-left",children:e.jsxs("div",{className:"tl-logo",children:[e.jsx("div",{className:"tl-logo-mark",children:e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",children:[e.jsx("path",{d:"M7 1L13 4V10L7 13L1 10V4L7 1Z",fill:"#050505"}),e.jsx("path",{d:"M7 1L13 4V10L7 13L1 10V4L7 1Z",fill:"currentColor",fillOpacity:".9"})]})}),e.jsxs("div",{className:"tl-logo-group",children:[e.jsx("span",{className:"tl-logo-name",children:"MotorIA Pro"}),e.jsx("span",{className:"tl-logo-status",children:"Ferramenta educativa"})]})]})}),e.jsxs("div",{className:"tl-header-right",children:[w&&g!==null?e.jsxs("div",{className:"tl-credits-pill tl-credits-paid",children:[e.jsx("span",{className:"tl-credits-dot"}),e.jsx("span",{className:"tl-credits-count",children:g}),e.jsxs("span",{className:"tl-credits-label",children:["análise",g!==1?"s":""]})]}):w?null:e.jsx("div",{className:"tl-credits-pill tl-credits-free",children:e.jsxs("span",{className:"tl-credits-label",children:[he," grátis"]})}),(g!==null&&g<=3||h)&&e.jsx("a",{href:B,className:"tl-header-buy",target:"_blank",rel:"noopener noreferrer",children:"+ créditos"}),e.jsx(je,{to:"/",className:"tl-header-back",children:"← Início"}),w&&e.jsx("button",{className:"tl-nav-logout",onClick:pe,children:"Sair"})]})]}),e.jsx("main",{className:"tl-main",children:e.jsxs("div",{className:"tl-wrap",children:[!a&&!d&&e.jsxs("div",{className:"tl-hero",children:[e.jsx("div",{className:"tl-hero-glow","aria-hidden":"true"}),e.jsx("div",{className:"tl-hero-eyebrow",children:"MotorIA Pro · Ferramenta educativa"}),e.jsxs("h1",{className:"tl-hero-title",children:["Veja o risco ",e.jsx("em",{className:"tl-hero-em",children:"REAL"}),e.jsx("br",{}),e.jsx("span",{className:"tl-hero-dim",children:"antes de apostar."})]}),e.jsx("p",{className:"tl-hero-sub",children:"A ferramenta mostra o que a plataforma não mostra: chance de perda, nível de perigo e o que você tende a perder no longo prazo."}),e.jsx("div",{className:"tl-trust-row",children:["Ferramenta educativa","Não vende previsões","Não promete lucro","+18"].map(t=>e.jsx("span",{className:"tl-trust-pill",children:t},t))})]}),h&&e.jsxs("div",{className:"tl-gate",children:[e.jsx("div",{className:"tl-gate-glow","aria-hidden":"true"}),e.jsx("div",{className:"tl-gate-icon","aria-hidden":"true",children:h==="no_credits"?e.jsxs("svg",{width:"22",height:"22",viewBox:"0 0 22 22",fill:"none",children:[e.jsx("circle",{cx:"11",cy:"11",r:"9",stroke:"currentColor",strokeWidth:"1.5"}),e.jsx("path",{d:"M11 7v5M11 15h.01",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})]}):e.jsxs("svg",{width:"22",height:"22",viewBox:"0 0 22 22",fill:"none",children:[e.jsx("path",{d:"M11 3L19 7V15L11 19L3 15V7L11 3Z",stroke:"currentColor",strokeWidth:"1.5",strokeLinejoin:"round"}),e.jsx("path",{d:"M11 8v4M11 15h.01",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round"})]})}),e.jsxs("div",{className:"tl-gate-body",children:[e.jsx("h2",{className:"tl-gate-title",children:h==="no_credits"?"Suas análises acabaram.":"Você usou as 2 análises gratuitas."}),e.jsx("p",{className:"tl-gate-sub",children:h==="no_credits"?"Recarregue 20 novas análises por R$27 e continue vendo o risco real antes de apostar.":"Para continuar vendo o risco real das suas apostas, desbloqueie o acesso completo — 20 análises por R$27."}),e.jsx("a",{href:B,className:"tl-gate-btn",target:"_blank",rel:"noopener noreferrer",children:"Comprar 20 análises — R$27 →"}),e.jsx("ul",{className:"tl-gate-feats",children:["20 análises incluídas","Nível de risco por aposta","O que pode dar errado em cada uma","Recarregável quando precisar"].map(t=>e.jsxs("li",{children:[e.jsx("span",{className:"tl-gate-check",children:"✓"})," ",t]},t))})]}),e.jsx("div",{className:"tl-gate-divider",children:e.jsx("span",{children:"Já tem um código de acesso?"})}),e.jsxs("form",{onSubmit:ce,className:"tl-token-form",children:[e.jsx("input",{className:"tl-input tl-token-input",placeholder:"Cole seu código de acesso aqui",value:W,onChange:t=>de(t.target.value),disabled:D,autoComplete:"off",spellCheck:!1}),M&&e.jsx("p",{className:"tl-token-err",children:M}),e.jsx("button",{className:"tl-token-btn",type:"submit",disabled:D,children:D?"Validando…":"Ativar acesso"})]})]}),!h&&!d&&!a&&e.jsxs("form",{className:"tl-form-card",onSubmit:ge,noValidate:!0,children:[e.jsxs("div",{className:"tl-form-header",children:[e.jsxs("div",{className:"tl-form-header-left",children:[e.jsx("div",{className:"tl-form-icon","aria-hidden":"true",children:e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none",children:[e.jsx("path",{d:"M7 1L13 4V10L7 13L1 10V4L7 1Z",fill:"currentColor",fillOpacity:".5"}),e.jsx("circle",{cx:"7",cy:"7",r:"2",fill:"currentColor"})]})}),e.jsx("span",{className:"tl-form-title",children:"Analisar minha aposta"})]}),e.jsx("span",{className:"tl-form-badge",children:"engine v2"})]}),e.jsxs("div",{className:"tl-field",children:[e.jsx("label",{className:"tl-label",children:"Jogo ou evento"}),e.jsx("input",{className:"tl-input",value:r,onChange:t=>n(t.target.value),placeholder:"Ex: Flamengo × Palmeiras, UFC 310, Djokovic × Alcaraz…",disabled:d})]}),e.jsxs("div",{className:"tl-field",children:[e.jsx("label",{className:"tl-label",children:"Tipo de aposta"}),e.jsx("select",{className:"tl-input tl-select",value:i,onChange:t=>x(t.target.value),disabled:d,children:we.map(t=>e.jsx("option",{children:t},t))})]}),e.jsxs("div",{className:"tl-row-2",children:[e.jsxs("div",{className:"tl-field",children:[e.jsxs("label",{className:"tl-label",children:["Odd",e.jsxs("span",{className:"tl-tooltip-wrap",tabIndex:"0","aria-label":"O que é odd?",children:[e.jsx("span",{className:"tl-info-icon",children:"?"}),e.jsx("span",{className:"tl-tooltip",role:"tooltip",children:"A odd é o multiplicador pago pela casa se você ganhar. Odd 2.00 = casa estima 50% de chance. Quanto maior a odd, menor essa chance — e maior o risco real."})]})]}),e.jsx("input",{className:"tl-input",value:k,onChange:t=>V(t.target.value),placeholder:"Ex: 1.80",inputMode:"decimal",disabled:d})]}),e.jsxs("div",{className:"tl-field",children:[e.jsxs("label",{className:"tl-label",children:["Valor pretendido ",e.jsx("span",{className:"tl-opt",children:"(opcional)"})]}),e.jsx("input",{className:"tl-input",value:C,onChange:t=>$(t.target.value),placeholder:"R$ 0,00",inputMode:"decimal",disabled:d})]})]}),e.jsxs("div",{className:"tl-field",children:[e.jsxs("label",{className:"tl-label",children:["Contexto adicional ",e.jsx("span",{className:"tl-opt",children:"(opcional)"})]}),e.jsx("textarea",{className:"tl-input tl-textarea",value:S,onChange:t=>q(t.target.value),placeholder:"Fase da competição, time fora de casa, lesões, momento da temporada, outros fatores relevantes…",disabled:d,rows:3})]}),e.jsx("p",{className:"tl-microcopy",children:"Quanto mais informação você der, mais precisa será a análise."}),U&&e.jsx("div",{className:"tl-err",children:U}),e.jsxs("button",{className:"tl-btn",type:"submit",disabled:d,children:["Ver o risco dessa aposta",e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M2.5 7H11.5M11.5 7L8 3.5M11.5 7L8 10.5",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})]})]}),d&&e.jsxs("div",{className:"tl-loading-panel",children:[e.jsx("div",{className:"tl-loading-glow","aria-hidden":"true"}),e.jsxs("div",{className:"tl-loading-top",children:[e.jsxs("div",{className:"tl-loading-ring","aria-hidden":"true",children:[e.jsxs("svg",{viewBox:"0 0 36 36",fill:"none",children:[e.jsx("circle",{cx:"18",cy:"18",r:"15",stroke:"rgba(31,203,122,0.12)",strokeWidth:"2.5"}),e.jsx("circle",{cx:"18",cy:"18",r:"15",stroke:"#1FCB7A",strokeWidth:"2.5",strokeDasharray:`${F*.942} 94.2`,strokeDashoffset:"23.55",strokeLinecap:"round",style:{transition:"stroke-dasharray .8s cubic-bezier(.4,0,.2,1)"}})]}),e.jsxs("span",{className:"tl-loading-pct",children:[F,"%"]})]}),e.jsxs("div",{className:"tl-loading-text",children:[e.jsx("div",{className:"tl-loading-step",children:b[O].label}),e.jsxs("div",{className:"tl-loading-sub",children:["Etapa ",O+1," de ",b.length]})]})]}),e.jsx("div",{className:"tl-prog-track",children:e.jsx("div",{className:"tl-prog-fill",style:{width:`${F}%`,transition:"width .8s cubic-bezier(.4,0,.2,1)"}})}),e.jsx("div",{className:"tl-prog-steps",children:b.map((t,l)=>e.jsxs("div",{className:`tl-prog-step${l<=O?" tl-prog-done":""}`,children:[e.jsx("span",{className:"tl-prog-dot"}),e.jsx("span",{className:"tl-prog-label",children:t.label})]},l))})]}),a&&!d&&e.jsxs("div",{className:"tl-result",ref:K,children:[e.jsxs("div",{className:"tl-report-hdr",children:[e.jsxs("div",{className:"tl-report-hdr-left",children:[e.jsx("span",{className:"tl-report-label",children:"RELATÓRIO DE RISCO"}),e.jsxs("span",{className:"tl-report-meta",children:[r||"Análise"," · odd ",a.oddN.toFixed(2)," · ",i]})]}),e.jsxs("div",{className:"tl-report-badges",children:[e.jsx("span",{className:"tl-report-badge",children:"MotorIA™"}),e.jsx("span",{className:"tl-report-ts",children:oe()})]})]}),e.jsxs("div",{className:"tl-card tl-card-score",style:{borderColor:s.color+"30",background:s.color+"07"},children:[e.jsx("div",{className:"tl-card-tag",style:{color:s.color+"80"},children:"NÍVEL DE RISCO · MOTORIA™"}),e.jsxs("div",{className:"tl-score-risk-banner",style:{color:s.color},children:["RISCO ",s.label]}),e.jsxs("div",{className:"tl-score-row",children:[e.jsx("div",{className:"tl-score-num",style:{color:s.color},children:s.score}),e.jsxs("div",{className:"tl-score-right",children:[e.jsx("span",{className:"tl-score-badge",style:{background:s.color+"18",color:s.color,border:`1px solid ${s.color}40`},children:s.score<=30?"Risco baixo — mais segura":s.score<=60?"Risco moderado — atenção":s.score<=80?"Risco alto — cuidado":"Risco crítico — perigo real"}),e.jsxs("div",{className:"tl-score-bar-wrap",children:[e.jsxs("div",{className:"tl-score-bar-track",children:[e.jsx("div",{className:"tl-score-bar-fill",style:{width:`${s.score}%`,background:s.color}}),[30,60,80].map(t=>e.jsx("div",{className:"tl-score-tick",style:{left:`${t}%`}},t))]}),e.jsxs("div",{className:"tl-score-bar-labels",children:[e.jsx("span",{children:"Baixo"}),e.jsx("span",{children:"Moderado"}),e.jsx("span",{children:"Alto"}),e.jsx("span",{children:"Crítico"})]})]})]})]}),e.jsx("p",{className:"tl-score-note",children:"Calculado a partir da odd e do contexto fornecido. Não recomenda nenhuma entrada — apenas mostra o nível de perigo dessa aposta."})]}),e.jsxs("div",{className:"tl-metrics-grid",children:[e.jsxs("div",{className:"tl-metric-card",children:[e.jsx("div",{className:"tl-metric-label",children:"Chance que a casa dá pra você ganhar"}),e.jsxs("div",{className:"tl-metric-val",style:{color:"#1FCB7A"},children:[a.prob.toFixed(1),"%"]}),e.jsx("div",{className:"tl-metric-hint",children:"o mínimo pra aposta valer a pena"})]}),e.jsxs("div",{className:"tl-metric-card",children:[e.jsx("div",{className:"tl-metric-label",children:"Chance de perder"}),e.jsxs("div",{className:"tl-metric-val",style:{color:R.color},children:["~",(100-a.prob).toFixed(1),"%",e.jsx("span",{className:"tl-metric-badge",style:{background:R.color+"18",color:R.color},children:R.label})]}),e.jsx("div",{className:"tl-metric-hint",children:"estimativa conservadora"})]}),e.jsxs("div",{className:"tl-metric-card",children:[e.jsx("div",{className:"tl-metric-label",children:"O que a casa retém de cada aposta"}),e.jsxs("div",{className:"tl-metric-val",style:{color:"#FFB020"},children:["~",a.vig.toFixed(1),"%"]}),e.jsx("div",{className:"tl-metric-hint",children:"antes mesmo do resultado"})]}),e.jsxs("div",{className:"tl-metric-card",children:[e.jsx("div",{className:"tl-metric-label",children:"O que você tende a perder por R$100"}),e.jsxs("div",{className:"tl-metric-val",style:{color:a.ev>=0?"#1FCB7A":"#FF4D2E"},children:[a.ev>=0?"+R$":"-R$",Math.abs(a.ev).toFixed(2)]}),e.jsx("div",{className:"tl-metric-hint",children:a.ev<-10?"perda esperada alta no longo prazo":a.ev<0?"desfavorável no longo prazo":"dentro da variância normal"})]})]}),a.ai.riscoPrincipal&&e.jsxs("div",{className:"tl-card tl-card-risk",children:[e.jsx("div",{className:"tl-card-tag",children:"① O PRINCIPAL RISCO DESSA APOSTA"}),e.jsx("p",{className:"tl-card-text",children:a.ai.riscoPrincipal})]}),a.ai.cenarioNecessario&&e.jsxs("div",{className:"tl-card tl-card-scenario",children:[e.jsx("div",{className:"tl-card-tag",children:"② O QUE PRECISA ACONTECER PRA VOCÊ GANHAR"}),e.jsx("p",{className:"tl-card-text",children:a.ai.cenarioNecessario})]}),te.length>0&&e.jsxs("div",{className:"tl-card tl-card-blind",children:[e.jsx("div",{className:"tl-card-tag",children:"③ O QUE PODE DAR ERRADO"}),e.jsx("ul",{className:"tl-bullets",children:te.map((t,l)=>e.jsx("li",{className:"tl-bullet",children:t},l))})]}),(a.ai.leituraConservadora||a.ai.alertaFinal)&&e.jsxs("div",{className:"tl-card tl-card-final",children:[e.jsx("div",{className:"tl-card-tag",children:"④ O QUE VOCÊ DEVERIA CONSIDERAR ANTES DE APOSTAR"}),a.ai.leituraConservadora&&e.jsx("p",{className:"tl-card-text",children:a.ai.leituraConservadora}),a.ai.alertaFinal&&e.jsx("blockquote",{className:"tl-quote",children:a.ai.alertaFinal}),e.jsx("p",{className:"tl-final-note",children:"Esta análise tem finalidade exclusivamente educativa. Não é recomendação de aposta. Apostas envolvem risco financeiro real."})]}),e.jsxs("div",{className:"tl-result-actions",children:[e.jsx("button",{className:"tl-new-btn",onClick:me,children:"← Nova análise"}),g!==null&&g<=5&&e.jsx("a",{href:B,className:"tl-recharge-btn",target:"_blank",rel:"noopener noreferrer",children:"+ 20 análises — R$27"})]})]}),X.length>0&&!d&&e.jsxs("div",{className:"tl-history",children:[e.jsxs("div",{className:"tl-history-hdr",children:[e.jsx("span",{className:"tl-history-title",children:"Últimas análises"}),e.jsx("button",{className:"tl-history-clear",onClick:()=>{Y([]),le([])},children:"Limpar"})]}),X.map(t=>e.jsxs("div",{className:"tl-history-row",children:[e.jsx("div",{className:"tl-history-score",style:{color:t.color},children:t.score}),e.jsxs("div",{className:"tl-history-info",children:[e.jsx("div",{className:"tl-history-jogo",children:t.jogo}),e.jsxs("div",{className:"tl-history-meta",children:[t.tipo," · odd ",t.odd.toFixed(2)]})]}),e.jsx("div",{className:"tl-history-label",style:{color:t.color},children:t.label}),e.jsx("div",{className:"tl-history-date",children:t.date})]},t.id))]})]})}),e.jsxs("footer",{className:"tl-footer",children:[e.jsx("p",{className:"tl-footer-text",children:"Ferramenta educativa. Não é recomendação de aposta. Apostas envolvem risco financeiro real. Proibido para menores de 18 anos."}),e.jsxs("div",{className:"tl-footer-links",children:[e.jsx("a",{href:"https://www.jogoresponsavel.com.br",target:"_blank",rel:"noopener noreferrer",children:"jogoresponsavel.com.br"}),e.jsx("span",{children:"·"}),e.jsx("span",{children:"CVV 188"}),e.jsx("span",{children:"·"}),e.jsx("span",{children:"+18"})]})]})]})}const Ce=`
/* ── Reset / Tokens ─────────────────────────────────────────────────────────── */
