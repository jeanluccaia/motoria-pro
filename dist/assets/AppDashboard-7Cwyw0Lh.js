import{r as o,j as e}from"./vendor-BnG4zNoI.js";import"./landing-Da8aCnG2.js";const ke=["Resultado da partida","Mais ou menos gols","Ambos marcam","Handicap","Empate devolve","Chance dupla","Primeiro gol","Escanteios","Cartões","Múltipla"],le={"Resultado da partida":"Análise baseada no vencedor da partida.","Mais ou menos gols":"Análise baseada na quantidade total de gols.","Ambos marcam":"Análise baseada na possibilidade dos dois times marcarem.",Handicap:"Análise com vantagem ou desvantagem aplicada a um dos times.","Empate devolve":"Aposta é devolvida se a partida terminar empatada.","Chance dupla":"Cobre dois dos três resultados possíveis da partida.","Primeiro gol":"Análise baseada em qual time marca o primeiro gol.",Escanteios:"Análise baseada no número total de escanteios da partida.",Cartões:"Análise baseada no número de cartões durante a partida.",Múltipla:"Combinação de múltiplas apostas em um único bilhete."},ze=["Brasileirão","Libertadores","Champions","Premier League","La Liga","Copa do Brasil","Série B"],O={Brasileirão:["Flamengo × Palmeiras","Corinthians × São Paulo","Grêmio × Athletico"],Libertadores:["Flamengo × River Plate","Palmeiras × Boca Juniors","Atlético × Nacional"],Champions:["Real Madrid × Bayern","PSG × Arsenal","Barcelona × Inter"],"Premier League":["Arsenal × Liverpool","Man City × Chelsea","Tottenham × Newcastle"],"La Liga":["Real Madrid × Barcelona","Atlético × Sevilla","Valencia × Villarreal"],"Copa do Brasil":["Flamengo × Athletico","Palmeiras × Fortaleza","São Paulo × Cruzeiro"],"Série B":["Sport × América-MG","Santos × Avaí","Novorizontino × Goiás"]},R=[{label:"Analisando odd informada",pct:16},{label:"Calculando chance estimada",pct:32},{label:"Medindo exposição da banca",pct:52},{label:"Avaliando retorno esperado",pct:70},{label:"Gerando leitura da IA",pct:86},{label:"Compilando painel de análise",pct:96}],F="motoria_token",ce="motoria_hist_v2",pe=8,Ce="https://pay.kiwify.com.br/DIVD8zl";function U(r){return 1/r*100}function Ee(r){return r<=1.4?4:r<=1.7?4.8:r<=2.2?5.5:r<=3?6.5:8}function Ae(r,m){return r/100*(m-1)*100-(1-r/100)*100}function de(r){const m=U(r),s=Math.min(100,Math.round(100-m));let x,n,p;return s<=30?(x="BAIXO",n="#22C55E",p="FAVORÁVEL"):s<=60?(x="MODERADO",n="#F59E0B",p="NEUTRO"):s<=80?(x="ALTO",n="#F97316",p="DESFAVORÁVEL"):(x="CRÍTICO",n="#EF4444",p="DESFAVORÁVEL"),{score:s,label:x,color:n,verdict:p}}function S(r,m){const s=r.match(new RegExp(`^${m}:[^\\n]*\\n([\\s\\S]*?)(?=\\n[A-Z_]{3,}:|$)`,"m")),x=r.match(new RegExp(`^${m}:\\s*(.+)`,"m"));return(s?s[1].trim():null)||(x?x[1].trim():null)}function Se(r){return{riscoPrincipal:S(r,"RISCO_PRINCIPAL"),cenarioNecessario:S(r,"CENARIO_NECESSARIO"),oQuePodeDarErrado:S(r,"O_QUE_PODE_DAR_ERRADO"),leituraConservadora:S(r,"LEITURA_CONSERVADORA"),alertaFinal:S(r,"ALERTA_FINAL")}}function Ie(){try{return JSON.parse(localStorage.getItem(ce)||"[]")}catch{return[]}}function Le(r){try{localStorage.setItem(ce,JSON.stringify(r))}catch{}}function Me(r){return r.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",second:"2-digit"})}function Oe(){return new Date().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",second:"2-digit"})}const Re=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("rect",{x:"1.5",y:"1.5",width:"4.5",height:"4.5",rx:"1.2",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("rect",{x:"8",y:"1.5",width:"4.5",height:"4.5",rx:"1.2",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("rect",{x:"1.5",y:"8",width:"4.5",height:"4.5",rx:"1.2",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("rect",{x:"8",y:"8",width:"4.5",height:"4.5",rx:"1.2",stroke:"currentColor",strokeWidth:"1.3"})]}),Fe=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("path",{d:"M2 11L5 7.5L8 9.5L12 3.5",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",strokeLinejoin:"round"}),e.jsx("circle",{cx:"5",cy:"7.5",r:"1",fill:"currentColor"}),e.jsx("circle",{cx:"8",cy:"9.5",r:"1",fill:"currentColor"}),e.jsx("circle",{cx:"12",cy:"3.5",r:"1",fill:"currentColor"})]}),Te=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("path",{d:"M2 10V6M5 10V4M8 10V7M11 10V3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round"}),e.jsx("path",{d:"M1 12.5h12",stroke:"currentColor",strokeWidth:"1.2",strokeLinecap:"round",opacity:".4"})]}),De=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("circle",{cx:"7",cy:"7",r:"2",fill:"currentColor",fillOpacity:".9"}),e.jsx("path",{d:"M3.5 3.5a5 5 0 0 0 0 7M10.5 3.5a5 5 0 0 1 0 7",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round"})]}),Be=()=>e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M7 1.5l1.5 3.2L12 5.3l-2.5 2.4.6 3.4L7 9.5l-3.1 1.6.6-3.4L2 5.3l3.5-.6L7 1.5z",stroke:"currentColor",strokeWidth:"1.3",strokeLinejoin:"round"})}),Ve=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("circle",{cx:"7",cy:"7",r:"5",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M7 4.5V7L8.8 8.8",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round"})]}),$e=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("circle",{cx:"7",cy:"7",r:"2",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M7 1v2M7 11v2M1 7h2M11 7h2M3.22 3.22l1.41 1.41M9.37 9.37l1.41 1.41M3.22 10.78l1.41-1.41M9.37 4.63l1.41-1.41",stroke:"currentColor",strokeWidth:"1.2",strokeLinecap:"round"})]});function _({mod:r,title:m,desc:s}){return e.jsxs("div",{className:"ap-content",children:[e.jsx("div",{className:"ap-panel-hdr",children:e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:r}),e.jsx("div",{className:"ap-panel-title",children:m})]})}),e.jsxs("div",{className:"ap-coming-panel",children:[e.jsx("div",{className:"ap-coming-icon","aria-hidden":"true",children:e.jsxs("svg",{width:"22",height:"22",viewBox:"0 0 22 22",fill:"none",children:[e.jsx("rect",{x:"1.5",y:"1.5",width:"19",height:"19",rx:"5",stroke:"rgba(255,255,255,.1)",strokeWidth:"1.5"}),e.jsx("path",{d:"M8 11h6M11 8v6",stroke:"rgba(255,255,255,.15)",strokeWidth:"1.5",strokeLinecap:"round"})]})}),e.jsx("p",{className:"ap-coming-desc",children:s}),e.jsx("div",{className:"ap-coming-tag",children:"Em desenvolvimento · Próxima versão"})]})]})}function Pe(r){return r<=30?"Exposição dentro do esperado.":r<=55?"Cenário exige atenção. Revise antes de confirmar.":r<=75?"Risco acima do ideal. Melhor rever o valor.":"Exposição muito alta. Cautela recomendada."}function We(r){return r<=30?{text:"Cenário equilibrado",color:"#22C55E",sub:"Exposição dentro do esperado para o perfil."}:r<=55?{text:"Ok com cautela",color:"#F59E0B",sub:"Revise o valor apostado antes de confirmar."}:r<=75?{text:"Risco elevado",color:"#F97316",sub:"Cenário menos favorável. Exposição acima do ideal."}:{text:"Exposição agressiva",color:"#EF4444",sub:"Risco alto. Melhor revisar banca e odd."}}function Ye({id:r,options:m,value:s,onChange:x}){const[n,p]=o.useState(!1),g=o.useRef(null);return o.useEffect(()=>{if(!n)return;function d(v){v.key==="Escape"&&p(!1)}function f(v){g.current&&!g.current.contains(v.target)&&p(!1)}return document.addEventListener("keydown",d),document.addEventListener("mousedown",f),()=>{document.removeEventListener("keydown",d),document.removeEventListener("mousedown",f)}},[n]),e.jsxs("div",{className:"sel-wrap",ref:g,children:[e.jsxs("button",{id:r,type:"button",className:`sel-trigger${n?" sel-trigger-open":""}`,onClick:()=>p(d=>!d),"aria-haspopup":"listbox","aria-expanded":n,children:[e.jsx("span",{className:"sel-val",children:s}),e.jsx("span",{className:`sel-chev${n?" sel-chev-up":""}`,"aria-hidden":"true",children:e.jsx("svg",{width:"10",height:"10",viewBox:"0 0 12 12",fill:"none",children:e.jsx("path",{d:"M2.5 4.5L6 8L9.5 4.5",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})})})]}),n&&e.jsx("ul",{className:"sel-list",role:"listbox","aria-label":"Mercado",children:m.map(d=>e.jsxs("li",{role:"option","aria-selected":d===s,className:`sel-opt${d===s?" sel-opt-on":""}`,onMouseDown:f=>f.preventDefault(),onClick:()=>{x(d),p(!1)},children:[e.jsx("span",{className:"sel-check","aria-hidden":"true",children:d===s&&e.jsx("svg",{width:"9",height:"9",viewBox:"0 0 12 12",fill:"none",children:e.jsx("path",{d:"M2.5 6L5 8.5L9.5 3.5",stroke:"currentColor",strokeWidth:"1.7",strokeLinecap:"round",strokeLinejoin:"round"})})}),e.jsx("span",{className:"sel-opt-text",children:d})]},d))})]})}function Ge(){o.useEffect(()=>{const a=document.title;return document.title="MotorIA Risk Engine™",()=>{document.title=a}},[]);const[r,m]=o.useState(new Date);o.useEffect(()=>{const a=setInterval(()=>m(new Date),1e3);return()=>clearInterval(a)},[]);const[s,x]=o.useState(!1);o.useEffect(()=>{try{const a=new URLSearchParams(window.location.search),i=a.get("t")||a.get("token");if(i&&i.length>10){localStorage.setItem(F,i),W(i),x(!0),window.history.replaceState(null,"",window.location.pathname);const l=setTimeout(()=>x(!1),4200);return()=>clearTimeout(l)}}catch{}},[]);const[n,p]=o.useState(!1),[g,d]=o.useState("nova");function f(a){d(a),p(!1)}const[v,I]=o.useState(""),[h,G]=o.useState(""),[y,xe]=o.useState("Resultado da partida"),[N,T]=o.useState(""),[D,K]=o.useState(""),[q,X]=o.useState(""),[B,L]=o.useState(!1),[k,Q]=o.useState(0),[V,$]=o.useState(0),[J,z]=o.useState(""),[t,M]=o.useState(null),[c,ge]=o.useState(Ie),[P,W]=o.useState(()=>localStorage.getItem(F)||""),[Z,me]=o.useState(null),[ee,be]=o.useState(null),b=parseFloat((N||"").replace(",",".")),Y=N&&!isNaN(b)&&b>=1.01?de(b):null,C=c.length?Math.round(c.reduce((a,i)=>a+(i.score||0),0)/c.length):null,ae=c[0]||null;async function he(a){if(a.preventDefault(),!N||isNaN(b)||b<1.01){z("Informe uma odd válida (mínimo 1.01).");return}L(!0),z(""),M(null),Q(0),$(R[0].pct);let i=0;const l=setInterval(()=>{i=Math.min(i+1,R.length-1),Q(i),$(R[i].pct)},820);try{const E=`Aposta: ${v||"não informado"} | Campeonato: ${h||"não informado"} | Tipo: ${y} | Odd: ${N} | Valor: R$${D||"100"} | Obs: ${q||"nenhuma"}`,j=await fetch("/api/chat",{method:"POST",headers:{"Content-Type":"application/json",...P?{"x-motoria-token":P}:{}},body:JSON.stringify({tool:"chance_de_perder",userMessage:E})});if(clearInterval(l),j.status===402){window.location.href=Ce;return}if(!j.ok){const Ne=await j.json().catch(()=>({}));z(Ne.error||"Erro ao processar análise."),L(!1);return}const u=await j.json(),A=u.content?.[0]?.text||"";u.credits!==void 0&&me(u.credits),u.token&&(localStorage.setItem(F,u.token),W(u.token));const w=U(b),ie=Ee(b),ve=w/(1-ie/100),oe=Math.min(ve,99),we=Ae(w,b),je=de(b),ye=Math.min(100,Math.round((100-oe)*1.1)),se=parseFloat(D)||100,H={id:Math.floor(Math.random()*8e3)+2e3,ts:Oe(),jogo:v||"Aposta",tipo:y,odd:b,impl:w.toFixed(2),justa:oe.toFixed(2),vig:ie.toFixed(2),ev:we.toFixed(2),perda:(100-w).toFixed(1),exposure:ye,valorAposta:se,valorRisco:(se*(100-w)/100).toFixed(2),...je,ai:Se(A)};M(H),be(H.id);const ne=[H,...c].slice(0,pe);ge(ne),Le(ne),$(100),setTimeout(()=>L(!1),280)}catch{clearInterval(l),z("Erro de conexão. Tente novamente."),L(!1)}}function re(a){M(a),I(a.jogo||""),T(String(a.odd)),d("nova")}function te(){M(null),z(""),I(""),T(""),K(""),X(""),G("")}function ue(a){const i=a.label==="CRÍTICO"?"MUITO ALTO":a.label,l=a.ai?.alertaFinal||a.ai?.leituraConservadora||"",E=[`MotorIA Pro · Análise #${a.id}`,`${a.jogo} | ${a.tipo} | Odd ${a.odd.toFixed(2)}`,"",`Risco da Aposta: ${a.score}/100 · ${i}`,`Chance Estimada: ${a.impl}%`,a.valorRisco?`Valor em Risco: R$ ${a.valorRisco}`:null,l?`Leitura da IA: "${l}"`:null,"","Análise educativa. Não representa garantia de resultado."].filter(Boolean).join(`
`);navigator.clipboard.writeText(E).catch(()=>{})}const fe=[{group:"ANÁLISE",items:[{id:"geral",label:"Visão Geral",Icon:Re},{id:"nova",label:"Nova Análise",Icon:Fe},{id:"comparador",label:"Comparador",Icon:Te,dim:!0}]},{group:"MERCADOS",items:[{id:"aovivo",label:"Ao Vivo",Icon:De,live:!0,dim:!0},{id:"favoritos",label:"Favoritos",Icon:Be,dim:!0}]},{group:"ARQUIVO",items:[{id:"historico",label:"Histórico",Icon:Ve,badge:c.length||null}]},{group:"SISTEMA",items:[{id:"config",label:"Configurações",Icon:$e}]}];return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:He}),n&&e.jsx("div",{className:"ap-overlay",onClick:()=>p(!1),"aria-hidden":"true"}),s&&e.jsxs("div",{className:"ap-access-banner",role:"status","aria-live":"polite",children:[e.jsx("span",{className:"ap-access-banner-dot","aria-hidden":"true"}),"Acesso ativado — plataforma pronta para uso"]}),e.jsxs("div",{className:"ap-shell",children:[e.jsxs("header",{className:"ap-topbar",children:[e.jsxs("div",{className:"ap-topbar-left",children:[e.jsxs("button",{className:"ap-hamburger",onClick:()=>p(a=>!a),"aria-label":"Menu","aria-expanded":n,children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]}),e.jsxs("div",{className:"ap-topbar-brand",children:[e.jsx("div",{className:"ap-logo-mark","aria-hidden":"true",children:e.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 14 14",fill:"none",children:[e.jsx("path",{d:"M7 1L13 4V10L7 13L1 10V4L7 1Z",fill:"#060608"}),e.jsx("path",{d:"M7 1L13 4V10L7 13L1 10V4L7 1Z",fill:"currentColor",fillOpacity:".95"})]})}),e.jsx("span",{className:"ap-topbar-name",children:"MotorIA"}),e.jsx("span",{className:"ap-topbar-sep","aria-hidden":"true",children:"·"}),e.jsx("span",{className:"ap-topbar-tag",children:"Risk Engine™"})]})]}),e.jsxs("div",{className:"ap-topbar-center",children:[e.jsx("span",{className:"ap-topbar-clock",children:Me(r)}),ee&&e.jsxs("span",{className:"ap-topbar-aid",children:[" · #",ee]})]}),e.jsxs("div",{className:"ap-topbar-right",children:[Z!==null&&e.jsx("div",{className:"ap-credits-wrap",title:"Créditos restantes",children:e.jsx("div",{className:"ap-credits-bar",children:e.jsx("div",{className:"ap-credits-fill",style:{width:`${Math.max(0,Z/20*100)}%`}})})}),e.jsxs("div",{className:"ap-engine-live",children:[e.jsx("span",{className:"ap-live-dot","aria-hidden":"true"}),e.jsx("span",{className:"ap-live-lbl",children:"ENGINE ATIVO"})]})]})]}),e.jsxs("div",{className:"ap-body",children:[e.jsxs("nav",{className:`ap-sidebar${n?" ap-sidebar-open":""}`,"aria-label":"Navegação",children:[e.jsxs("div",{className:"ap-sidebar-brand",children:[e.jsx("div",{className:"ap-sidebar-brand-mark","aria-hidden":"true",children:e.jsx("svg",{width:"9",height:"9",viewBox:"0 0 14 14",fill:"none",children:e.jsx("path",{d:"M7 1L13 4V10L7 13L1 10V4L7 1Z",fill:"#22C55E"})})}),e.jsx("span",{className:"ap-sidebar-brand-name",children:"MotorIA Pro"})]}),e.jsx("div",{className:"ap-sidebar-divider",role:"separator"}),fe.map(({group:a,items:i})=>e.jsxs("div",{className:"ap-sidebar-group",children:[e.jsx("div",{className:"ap-sidebar-group-lbl",children:a}),i.map(({id:l,label:E,Icon:j,badge:u,live:A,dim:w})=>e.jsxs("button",{className:`ap-nav-item${g===l?" ap-nav-active":""}${w?" ap-nav-dim":""}`,onClick:()=>f(l),"aria-current":g===l?"page":void 0,children:[e.jsx("span",{className:"ap-nav-icon",children:e.jsx(j,{})}),e.jsx("span",{className:"ap-nav-label",children:E}),A&&e.jsx("span",{className:"ap-nav-live-dot","aria-label":"ao vivo"}),u>0&&!A&&e.jsx("span",{className:"ap-nav-badge","aria-label":`${u} itens`,children:u}),w&&!A&&e.jsx("span",{className:"ap-nav-soon","aria-label":"em breve",children:e.jsxs("svg",{width:"8",height:"8",viewBox:"0 0 10 10",fill:"none",children:[e.jsx("path",{d:"M5 2v3.5M5 7v.5",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round"}),e.jsx("circle",{cx:"5",cy:"5",r:"4",stroke:"currentColor",strokeWidth:"1.2",opacity:".5"})]})})]},l))]},a)),e.jsxs("div",{className:"ap-sidebar-engine",children:[e.jsx("div",{className:"ap-sidebar-engine-dot","aria-hidden":"true"}),e.jsxs("div",{className:"ap-sidebar-engine-info",children:[e.jsx("span",{className:"ap-sidebar-engine-name",children:"RISK ENGINE v2.4"}),e.jsx("span",{className:"ap-sidebar-engine-status",children:"ONLINE"})]})]})]}),e.jsxs("main",{className:"ap-main",children:[g==="geral"&&e.jsxs("div",{className:"ap-content",children:[e.jsxs("div",{className:"ap-panel-hdr",children:[e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:"MÓDULO I"}),e.jsx("div",{className:"ap-panel-title",children:"Visão Geral"})]}),e.jsxs("div",{className:"ap-panel-online",children:[e.jsx("span",{className:"ap-status-dot","aria-hidden":"true"}),"SISTEMA ONLINE"]})]}),e.jsxs("div",{className:"ap-geral-stats",children:[e.jsxs("div",{className:"ap-geral-stat",children:[e.jsx("div",{className:"ap-geral-stat-val",children:c.length}),e.jsx("div",{className:"ap-geral-stat-lbl",children:"ANÁLISES"})]}),e.jsxs("div",{className:"ap-geral-stat",children:[e.jsx("div",{className:"ap-geral-stat-val",style:{color:C!==null?C>60?"#EF4444":C>40?"#F59E0B":"#22C55E":"var(--t3)"},children:C!==null?C:"—"}),e.jsx("div",{className:"ap-geral-stat-lbl",children:"SCORE MÉDIO"})]}),e.jsxs("div",{className:"ap-geral-stat",children:[e.jsx("div",{className:"ap-geral-stat-val",children:ae?ae.odd.toFixed(2):"—"}),e.jsx("div",{className:"ap-geral-stat-lbl",children:"ÚLTIMA ODD"})]}),e.jsxs("div",{className:"ap-geral-stat",children:[e.jsx("div",{className:"ap-geral-stat-val ap-geral-stat-val-sm",children:"v2.4"}),e.jsx("div",{className:"ap-geral-stat-lbl",children:"ENGINE"})]})]}),e.jsxs("div",{className:"ap-geral-action",children:[e.jsxs("div",{className:"ap-geral-action-left",children:[e.jsx("div",{className:"ap-geral-action-title",children:"Iniciar nova análise quantitativa"}),e.jsx("div",{className:"ap-geral-action-sub",children:"MOTORIA RISK INDEX™ · Probabilidade · EV · Exposição"})]}),e.jsxs("button",{className:"ap-geral-btn",onClick:()=>f("nova"),children:["Analisar",e.jsx("svg",{width:"11",height:"11",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M2.5 7H11.5M11.5 7L8 3.5M11.5 7L8 10.5",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})})]})]}),c.length>0&&e.jsxs("div",{className:"ap-geral-recent",children:[e.jsx("div",{className:"ap-geral-recent-hdr",children:"ANÁLISES RECENTES"}),e.jsx("div",{className:"ap-geral-recent-list",children:c.slice(0,4).map((a,i)=>e.jsxs("button",{className:"ap-geral-recent-row",onClick:()=>re(a),children:[e.jsxs("span",{className:"ap-geral-recent-id",children:["#",a.id]}),e.jsx("span",{className:"ap-geral-recent-event",children:a.jogo||"Aposta"}),e.jsxs("span",{className:"ap-geral-recent-odd",children:["Odd ",a.odd]}),e.jsx("div",{className:"ap-geral-recent-bar",children:e.jsx("div",{style:{width:`${a.score}%`,background:a.color,height:"100%",borderRadius:99}})}),e.jsx("span",{className:"ap-geral-recent-score",style:{color:a.color},children:a.score}),e.jsx("span",{className:"ap-geral-recent-tag",style:{color:a.color},children:a.label})]},i))})]}),c.length===0&&e.jsxs("div",{className:"ap-geral-empty",children:[e.jsx("p",{children:"Nenhuma análise registrada ainda."}),e.jsx("button",{className:"ap-geral-btn",onClick:()=>f("nova"),children:"Iniciar primeira análise →"})]})]},"geral"),g==="nova"&&e.jsxs("div",{className:"ap-content",children:[!t&&!B&&e.jsxs("section",{className:"ap-input-panel",children:[e.jsxs("div",{className:"ap-panel-hdr ap-form-hdr",children:[e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-nova-title",children:"NOVA ANÁLISE"}),e.jsx("div",{className:"ap-nova-sub",children:"Configure os dados da aposta para gerar uma leitura de risco."})]}),e.jsxs("div",{className:"ap-ia-online",children:[e.jsx("span",{className:"ap-status-dot","aria-hidden":"true"}),"IA ONLINE"]})]}),e.jsxs("form",{className:"ap-form",onSubmit:he,noValidate:!0,children:[e.jsxs("div",{className:"ap-form-anchor","aria-hidden":"true",children:[e.jsxs("svg",{width:"9",height:"9",viewBox:"0 0 12 12",fill:"none",children:[e.jsx("circle",{cx:"6",cy:"6",r:"4.5",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M6 3.5v2.3L7.5 7",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round"})]}),"Análise matemática de risco em tempo real"]}),e.jsxs("div",{className:"ap-row-2",children:[e.jsxs("div",{className:"ap-field",children:[e.jsx("label",{className:"ap-label",htmlFor:"odd-input",children:"ODD DECIMAL"}),e.jsx("input",{id:"odd-input",className:"ap-input ap-input-odd",type:"text",placeholder:"2.80",value:N,onChange:a=>T(a.target.value),inputMode:"decimal",autoComplete:"off"}),Y&&e.jsxs("div",{className:"ap-odd-preview",style:{color:Y.color},children:[e.jsx("span",{children:Y.label}),e.jsx("span",{className:"ap-odd-preview-sep",children:"·"}),e.jsxs("span",{children:["impl. ",U(b).toFixed(1),"%"]})]})]}),e.jsxs("div",{className:"ap-field",children:[e.jsx("label",{className:"ap-label",htmlFor:"valor-input",children:"EXPOSIÇÃO (R$)"}),e.jsx("input",{id:"valor-input",className:"ap-input",type:"text",placeholder:"100",value:D,onChange:a=>K(a.target.value),inputMode:"decimal",autoComplete:"off"})]})]}),e.jsxs("div",{className:"ap-field",children:[e.jsx("label",{className:"ap-label",htmlFor:"tipo-input",children:"MERCADO"}),e.jsx(Ye,{id:"tipo-input",options:ke,value:y,onChange:xe}),le[y]&&e.jsxs("div",{className:"ap-tipo-desc",children:[e.jsx("span",{className:"ap-tipo-desc-dot","aria-hidden":"true"}),le[y]]})]}),e.jsxs("div",{className:"ap-field",children:[e.jsxs("label",{className:"ap-label",children:["CAMPEONATO ",e.jsx("span",{className:"ap-label-opt",children:"/ opcional"})]}),e.jsx("div",{className:"ap-chips-wrap",role:"group","aria-label":"Selecione o campeonato",children:ze.map(a=>e.jsx("button",{type:"button",className:`ap-chip${h===a?" ap-chip-on":""}`,onClick:()=>G(h===a?"":a),"aria-pressed":h===a,children:a},a))})]}),e.jsxs("div",{className:"ap-field",children:[e.jsxs("label",{className:"ap-label",htmlFor:"jogo-input",children:["PARTIDA ",e.jsx("span",{className:"ap-label-opt",children:"/ opcional"})]}),e.jsx("input",{id:"jogo-input",className:"ap-input",type:"text",placeholder:h&&O[h]?`Ex: ${O[h][0]}`:"Ex: Flamengo × Palmeiras",value:v,onChange:a=>I(a.target.value),autoComplete:"off"}),h&&O[h]&&!v&&e.jsx("div",{className:"ap-suggestions","aria-label":"Sugestões de partida",children:O[h].map(a=>e.jsx("button",{type:"button",className:"ap-sug-item",onClick:()=>I(a),children:a},a))})]}),e.jsxs("div",{className:"ap-field",children:[e.jsxs("label",{className:"ap-label",htmlFor:"obs-input",children:["CONTEXTO ",e.jsx("span",{className:"ap-label-opt",children:"/ opcional"})]}),e.jsx("textarea",{id:"obs-input",className:"ap-input ap-textarea",placeholder:"Desfalques, forma recente, condições do jogo…",value:q,onChange:a=>X(a.target.value),rows:2})]}),J&&e.jsx("div",{className:"ap-error",role:"alert",children:J}),e.jsx("button",{className:"ap-submit",type:"submit",children:"INICIAR ANÁLISE →"})]})]}),B&&e.jsxs("div",{className:"ap-loading",role:"status","aria-live":"polite",children:[e.jsxs("div",{className:"ap-loading-hdr",children:[e.jsxs("div",{children:[e.jsx("div",{className:"ap-loading-engine",children:"RISK ENGINE v2.4"}),e.jsx("div",{className:"ap-loading-sub",children:"Processamento quantitativo em execução"})]}),e.jsx("span",{className:"ap-loading-status",children:"CALCULANDO"})]}),e.jsx("div",{className:"ap-loading-bar-wrap",children:e.jsx("div",{className:"ap-loading-bar",style:{width:`${V}%`}})}),e.jsxs("div",{className:"ap-loading-pct","aria-label":`${V}%`,children:[V,e.jsx("span",{className:"ap-loading-pct-sym",children:"%"})]}),e.jsx("div",{className:"ap-loading-steps",children:R.map((a,i)=>e.jsxs("div",{className:`ap-lstep${i<k?" ap-lstep-done":i===k?" ap-lstep-active":""}`,children:[e.jsx("span",{className:"ap-lstep-icon","aria-hidden":"true",children:i<k?"✓":i===k?"▶":"○"}),e.jsx("span",{className:"ap-lstep-lbl",children:a.label}),i<k&&e.jsx("span",{className:"ap-lstep-done-tag",children:"OK"})]},i))})]}),t&&!B&&(()=>{const a=We(t.score),i=t.label==="CRÍTICO"?"MUITO ALTO":t.label,l=t.ai?.alertaFinal||t.ai?.leituraConservadora||a.sub;return e.jsxs("div",{className:"db-output",role:"region","aria-label":"Resultado da análise",children:[e.jsxs("div",{className:"db-topbar",children:[e.jsxs("div",{className:"db-topbar-meta",children:[e.jsxs("span",{className:"db-id",children:["#",t.id]}),e.jsx("span",{className:"db-sep","aria-hidden":"true",children:"·"}),e.jsx("span",{className:"db-ts",children:t.ts}),e.jsx("span",{className:"db-sep","aria-hidden":"true",children:"·"}),e.jsxs("span",{className:"db-ai-badge",children:[e.jsx("span",{className:"db-ai-dot","aria-hidden":"true"}),"IA ativa"]})]}),e.jsx("button",{className:"db-btn-ghost",onClick:te,"aria-label":"Nova análise",children:"Nova análise →"})]}),e.jsxs("div",{className:"db-result-card",children:[e.jsxs("div",{className:"db-rc-header",children:[e.jsx("div",{className:"db-rc-event",children:t.jogo!=="Aposta"?t.jogo:t.tipo}),e.jsxs("div",{className:"db-rc-meta",children:[t.jogo!=="Aposta"&&e.jsx("span",{className:"db-rc-badge",children:t.tipo}),e.jsxs("span",{className:"db-rc-odd",children:["Odd ",t.odd.toFixed(2)]}),t.valorAposta&&e.jsxs("span",{className:"db-rc-valor",children:["R$ ",t.valorAposta.toFixed(0)]})]})]}),e.jsx("div",{className:"db-rc-divider"}),e.jsxs("div",{className:"db-rc-risk",children:[e.jsxs("div",{className:"db-rc-risk-top",children:[e.jsx("span",{className:"db-rc-label",children:"Risco da Aposta"}),e.jsx("span",{className:"db-rc-level",style:{color:t.color},children:i})]}),e.jsxs("div",{className:"db-rc-score",style:{color:t.color},children:[t.score,e.jsx("span",{className:"db-rc-score-denom",children:"/100"})]}),e.jsx("div",{className:"db-rbar-wrap",role:"img","aria-label":`Risco ${t.score} de 100`,children:e.jsxs("div",{className:"db-rbar-track",children:[e.jsx("div",{className:"db-rbar-zone db-rbar-z1"}),e.jsx("div",{className:"db-rbar-zone db-rbar-z2"}),e.jsx("div",{className:"db-rbar-zone db-rbar-z3"}),e.jsx("div",{className:"db-rbar-zone db-rbar-z4"}),e.jsx("div",{className:"db-rbar-marker",style:{left:`calc(${Math.min(t.score,98)}% - 5px)`}})]})}),e.jsx("div",{className:"db-rc-phrase",children:Pe(t.score)})]}),e.jsx("div",{className:"db-rc-divider"}),e.jsxs("div",{className:"db-rc-data",children:[e.jsxs("div",{className:"db-rc-data-item",children:[e.jsx("span",{className:"db-rc-label",children:"Chance estimada"}),e.jsxs("span",{className:"db-rc-big db-rc-big-green",children:[t.impl,e.jsx("span",{className:"db-rc-sym",children:"%"})]}),e.jsxs("span",{className:"db-rc-sub",children:[t.perda,"% de não converter"]})]}),e.jsx("div",{className:"db-rc-data-sep"}),e.jsxs("div",{className:"db-rc-data-item",children:[e.jsx("span",{className:"db-rc-label",children:"Valor em risco"}),e.jsxs("span",{className:"db-rc-big",style:{color:t.color},children:["R$",e.jsx("span",{children:t.valorRisco||"—"})]}),e.jsxs("span",{className:"db-rc-sub",children:["de R$ ",t.valorAposta?.toFixed(0)||"—"," apostados"]})]})]}),e.jsx("div",{className:"db-rc-divider"}),e.jsxs("div",{className:"db-rc-ai",children:[e.jsx("span",{className:"db-rc-label",children:"Leitura da IA"}),e.jsxs("div",{className:"db-rc-ai-verdict",style:{color:a.color},children:[e.jsx("span",{className:"db-rc-ai-dot",style:{background:a.color},"aria-hidden":"true"}),a.text]}),l&&e.jsxs("p",{className:"db-rc-ai-sentence",children:['"',l,'"']})]})]}),e.jsxs("div",{className:"db-actions",children:[e.jsxs("button",{className:"db-btn-primary",onClick:te,children:[e.jsx("svg",{width:"11",height:"11",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M2.5 7H11.5M11.5 7L8 3.5M11.5 7L8 10.5",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})}),"Nova análise"]}),e.jsxs("button",{className:"db-btn-copy",onClick:()=>ue(t),title:"Copiar resumo",children:[e.jsxs("svg",{width:"11",height:"11",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("rect",{x:"5",y:"5",width:"8",height:"8",rx:"1.5",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M9 5V3a1 1 0 00-1-1H3a1 1 0 00-1 1v5a1 1 0 001 1h2",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round"})]}),"Copiar"]})]}),e.jsx("p",{className:"db-disclaimer",children:"Análise educativa. Não representa garantia de resultado. A decisão é sua."})]})})()]},"nova"),g==="comparador"&&e.jsx(_,{mod:"MÓDULO III",title:"Comparador de Odds",desc:"Compare múltiplas odds simultaneamente e identifique distorções entre casas de apostas. O Comparador cruza probabilidades implícitas em tempo real."}),g==="aovivo"&&e.jsx(_,{mod:"MERCADOS",title:"Ao Vivo",desc:"Feed de análises em tempo real com atualizações automáticas de probabilidade para eventos em andamento. Integração com dados de mercado ao vivo."}),g==="favoritos"&&e.jsx(_,{mod:"ARQUIVO",title:"Favoritos",desc:"Salve e organize suas análises mais relevantes. Crie coleções por campeonato, mercado ou período para consulta rápida."}),g==="historico"&&e.jsxs("div",{className:"ap-content",children:[e.jsxs("div",{className:"ap-panel-hdr",children:[e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:"ARQUIVO"}),e.jsx("div",{className:"ap-panel-title",children:"Histórico de análises"})]}),e.jsxs("div",{className:"ap-panel-online",children:[e.jsx("span",{className:"ap-status-dot","aria-hidden":"true"}),c.length," REGISTROS"]})]}),c.length===0?e.jsx("div",{className:"ap-empty",children:"Nenhuma análise registrada nesta sessão."}):e.jsx("div",{className:"ap-hist-list",children:c.map((a,i)=>e.jsxs("button",{className:"ap-hist-row",onClick:()=>re(a),children:[e.jsxs("span",{className:"ap-hist-id",children:["#",a.id||"—"]}),e.jsx("span",{className:"ap-hist-event",children:a.jogo||"Aposta"}),e.jsxs("span",{className:"ap-hist-odd",children:["Odd ",a.odd]}),e.jsx("div",{className:"ap-hist-bar",children:e.jsx("div",{style:{width:`${a.score}%`,background:a.color,height:"100%",borderRadius:99}})}),e.jsx("span",{className:"ap-hist-score",style:{color:a.color},children:a.score}),e.jsx("span",{className:"ap-hist-tag",style:{color:a.color,borderColor:`${a.color}33`},children:a.label}),e.jsx("span",{className:"ap-hist-ts",children:a.ts||""})]},i))})]},"historico"),g==="config"&&e.jsxs("div",{className:"ap-content",children:[e.jsx("div",{className:"ap-panel-hdr",children:e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:"SISTEMA"}),e.jsx("div",{className:"ap-panel-title",children:"Configurações"})]})}),e.jsxs("div",{className:"ap-config-panel",children:[e.jsxs("div",{className:"ap-config-field",children:[e.jsx("label",{className:"ap-label",htmlFor:"token-input",children:"TOKEN DE ACESSO"}),e.jsx("input",{id:"token-input",className:"ap-input ap-input-mono",type:"text",placeholder:"Cole seu token de acesso aqui",value:P,onChange:a=>{W(a.target.value),localStorage.setItem(F,a.target.value)},autoComplete:"off",spellCheck:!1}),e.jsx("p",{className:"ap-config-hint",children:"Token recebido por email após a confirmação de acesso."})]}),e.jsxs("div",{className:"ap-config-info",children:[e.jsxs("div",{className:"ap-config-row",children:[e.jsx("span",{children:"Engine"}),e.jsx("span",{children:"MotorIA Risk Engine™ v2.4"})]}),e.jsxs("div",{className:"ap-config-row",children:[e.jsx("span",{children:"Modelo"}),e.jsx("span",{children:"Quantitative Risk v2"})]}),e.jsxs("div",{className:"ap-config-row",children:[e.jsx("span",{children:"Histórico local"}),e.jsxs("span",{children:[c.length," / ",pe]})]}),e.jsxs("div",{className:"ap-config-row",children:[e.jsx("span",{children:"Status"}),e.jsx("span",{className:"ap-config-online",children:"● ONLINE"})]})]})]})]},"config")]})]})]})]})}const He=`
