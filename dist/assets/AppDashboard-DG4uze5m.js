import{r as n,j as e}from"./vendor-BnG4zNoI.js";import"./landing-BVTIqeJr.js";const Ae=["Resultado da partida","Mais ou menos gols","Ambos marcam","Handicap","Empate devolve","Chance dupla","Primeiro gol","Escanteios","Cartões","Múltipla"],Ze=["Brasileirão","Libertadores","Champions","Premier League","La Liga","Copa do Brasil","Série B"],Se=[{tipo:"Resultado da partida",ref:"1.85"},{tipo:"Mais ou menos gols",ref:"1.90"},{tipo:"Ambos marcam",ref:"1.95"},{tipo:"Handicap",ref:"2.10"},{tipo:"Empate devolve",ref:"1.65"},{tipo:"Chance dupla",ref:"1.40"}],de={"Resultado da partida":"1.85","Mais ou menos gols":"1.90","Ambos marcam":"1.95",Handicap:"2.10","Empate devolve":"1.65","Chance dupla":"1.40","Primeiro gol":"3.50",Escanteios:"1.90",Cartões:"1.85",Múltipla:"4.00"},V=[{label:"Analisando odd informada",pct:16},{label:"Calculando chance estimada",pct:32},{label:"Medindo exposição da banca",pct:52},{label:"Avaliando retorno esperado",pct:70},{label:"Gerando leitura da IA",pct:86},{label:"Compilando painel de análise",pct:96}],K="motoria_token",Re="motoria_hist_v2",Le=8,ea="https://pay.kiwify.com.br/DIVD8zl";function xe(t){return 1/t*100}function aa(t){return t<=1.4?4:t<=1.7?4.8:t<=2.2?5.5:t<=3?6.5:8}function ra(t,l){return t/100*(l-1)*100-(1-t/100)*100}function Ie(t){const l=xe(t),d=Math.min(100,Math.round(100-l));let h,g,m;return d<=30?(h="BAIXO",g="#22C55E",m="FAVORÁVEL"):d<=60?(h="MODERADO",g="#F59E0B",m="NEUTRO"):d<=80?(h="ALTO",g="#F97316",m="DESFAVORÁVEL"):(h="CRÍTICO",g="#EF4444",m="DESFAVORÁVEL"),{score:d,label:h,color:g,verdict:m}}function B(t,l){const d=t.match(new RegExp(`^${l}:[^\\n]*\\n([\\s\\S]*?)(?=\\n[A-Z_]{3,}:|$)`,"m")),h=t.match(new RegExp(`^${l}:\\s*(.+)`,"m"));return(d?d[1].trim():null)||(h?h[1].trim():null)}function ta(t){return{riscoPrincipal:B(t,"RISCO_PRINCIPAL"),cenarioNecessario:B(t,"CENARIO_NECESSARIO"),oQuePodeDarErrado:B(t,"O_QUE_PODE_DAR_ERRADO"),leituraConservadora:B(t,"LEITURA_CONSERVADORA"),alertaFinal:B(t,"ALERTA_FINAL")}}function ia(){try{return JSON.parse(localStorage.getItem(Re)||"[]")}catch{return[]}}function sa(t){try{localStorage.setItem(Re,JSON.stringify(t))}catch{}}function oa(t){return t.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",second:"2-digit"})}function na(){return new Date().toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit",second:"2-digit"})}function J(t){const l=(t||"").toLowerCase();return l.includes("serie b")||l.includes("série b")?"Série B":l.includes("brasileir")||l.includes("brazil")&&l.includes("serie a")?"Brasileirão":l.includes("libertad")?"Libertadores":l.includes("champions")?"Champions":l.includes("premier league")?"Premier League":l.includes("la liga")||l.includes("laliga")||l.includes("primera division")?"La Liga":l.includes("copa do brasil")?"Copa do Brasil":l.includes("bundesliga")?"Bundesliga":l.includes("ligue 1")?"Ligue 1":""}const la=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("rect",{x:"1.5",y:"1.5",width:"4.5",height:"4.5",rx:"1.2",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("rect",{x:"8",y:"1.5",width:"4.5",height:"4.5",rx:"1.2",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("rect",{x:"1.5",y:"8",width:"4.5",height:"4.5",rx:"1.2",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("rect",{x:"8",y:"8",width:"4.5",height:"4.5",rx:"1.2",stroke:"currentColor",strokeWidth:"1.3"})]}),da=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("path",{d:"M2 11L5 7.5L8 9.5L12 3.5",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round",strokeLinejoin:"round"}),e.jsx("circle",{cx:"5",cy:"7.5",r:"1",fill:"currentColor"}),e.jsx("circle",{cx:"8",cy:"9.5",r:"1",fill:"currentColor"}),e.jsx("circle",{cx:"12",cy:"3.5",r:"1",fill:"currentColor"})]}),pa=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("path",{d:"M2 10V6M5 10V4M8 10V7M11 10V3",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round"}),e.jsx("path",{d:"M1 12.5h12",stroke:"currentColor",strokeWidth:"1.2",strokeLinecap:"round",opacity:".4"})]}),ca=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("circle",{cx:"7",cy:"7",r:"2",fill:"currentColor",fillOpacity:".9"}),e.jsx("path",{d:"M3.5 3.5a5 5 0 0 0 0 7M10.5 3.5a5 5 0 0 1 0 7",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round"})]}),xa=()=>e.jsx("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M7 1.5l1.5 3.2L12 5.3l-2.5 2.4.6 3.4L7 9.5l-3.1 1.6.6-3.4L2 5.3l3.5-.6L7 1.5z",stroke:"currentColor",strokeWidth:"1.3",strokeLinejoin:"round"})}),ga=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("circle",{cx:"7",cy:"7",r:"5",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M7 4.5V7L8.8 8.8",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round"})]}),ma=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("circle",{cx:"7",cy:"7",r:"2",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M7 1v2M7 11v2M1 7h2M11 7h2M3.22 3.22l1.41 1.41M9.37 9.37l1.41 1.41M3.22 10.78l1.41-1.41M9.37 4.63l1.41-1.41",stroke:"currentColor",strokeWidth:"1.2",strokeLinecap:"round"})]}),ha=()=>e.jsxs("svg",{width:"14",height:"14",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("rect",{x:"1.5",y:"3",width:"11",height:"9.5",rx:"1.5",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M1.5 6h11",stroke:"currentColor",strokeWidth:"1.2"}),e.jsx("path",{d:"M4.5 1.5V4M9.5 1.5V4",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round"}),e.jsx("circle",{cx:"4.5",cy:"9",r:".9",fill:"currentColor",opacity:".55"}),e.jsx("circle",{cx:"7",cy:"9",r:".9",fill:"currentColor",opacity:".55"}),e.jsx("circle",{cx:"9.5",cy:"9",r:".9",fill:"currentColor",opacity:".55"})]});function pe({mod:t,title:l,desc:d}){return e.jsxs("div",{className:"ap-content",children:[e.jsx("div",{className:"ap-panel-hdr",children:e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:t}),e.jsx("div",{className:"ap-panel-title",children:l})]})}),e.jsxs("div",{className:"ap-coming-panel",children:[e.jsx("div",{className:"ap-coming-icon","aria-hidden":"true",children:e.jsxs("svg",{width:"22",height:"22",viewBox:"0 0 22 22",fill:"none",children:[e.jsx("rect",{x:"1.5",y:"1.5",width:"19",height:"19",rx:"5",stroke:"rgba(255,255,255,.1)",strokeWidth:"1.5"}),e.jsx("path",{d:"M8 11h6M11 8v6",stroke:"rgba(255,255,255,.15)",strokeWidth:"1.5",strokeLinecap:"round"})]})}),e.jsx("p",{className:"ap-coming-desc",children:d}),e.jsx("div",{className:"ap-coming-tag",children:"Em desenvolvimento · Próxima versão"})]})]})}function Oe(t){return t<=30?"Exposição dentro do esperado.":t<=55?"Cenário exige atenção. Revise antes de confirmar.":t<=75?"Risco acima do ideal. Melhor rever o valor.":"Exposição muito alta. Cautela recomendada."}function Me(t){return t<=30?{text:"Cenário equilibrado",color:"#22C55E",sub:"Exposição dentro do esperado para o perfil."}:t<=55?{text:"Ok com cautela",color:"#F59E0B",sub:"Revise o valor apostado antes de confirmar."}:t<=75?{text:"Risco elevado",color:"#F97316",sub:"Cenário menos favorável. Exposição acima do ideal."}:{text:"Exposição agressiva",color:"#EF4444",sub:"Risco alto. Melhor revisar banca e odd."}}function ce({id:t,options:l,value:d,onChange:h,placeholder:g}){const[m,c]=n.useState(!1),L=n.useRef(null);return n.useEffect(()=>{if(!m)return;function x(k){k.key==="Escape"&&c(!1)}function f(k){L.current&&!L.current.contains(k.target)&&c(!1)}return document.addEventListener("keydown",x),document.addEventListener("mousedown",f),()=>{document.removeEventListener("keydown",x),document.removeEventListener("mousedown",f)}},[m]),e.jsxs("div",{className:"sel-wrap",ref:L,children:[e.jsxs("button",{id:t,type:"button",className:`sel-trigger${m?" sel-trigger-open":""}`,onClick:()=>c(x=>!x),"aria-haspopup":"listbox","aria-expanded":m,children:[e.jsx("span",{className:`sel-val${g&&!l.includes(d)?" sel-placeholder":""}`,children:g&&!l.includes(d)?g:d}),e.jsx("span",{className:`sel-chev${m?" sel-chev-up":""}`,"aria-hidden":"true",children:e.jsx("svg",{width:"10",height:"10",viewBox:"0 0 12 12",fill:"none",children:e.jsx("path",{d:"M2.5 4.5L6 8L9.5 4.5",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})})})]}),m&&e.jsxs("ul",{className:"sel-list",role:"listbox","aria-label":g||"Opções",children:[g&&e.jsxs("li",{role:"option","aria-selected":!l.includes(d),className:`sel-opt${l.includes(d)?"":" sel-opt-on"}`,onMouseDown:x=>x.preventDefault(),onClick:()=>{h(""),c(!1)},children:[e.jsx("span",{className:"sel-check","aria-hidden":"true",children:!l.includes(d)&&e.jsx("svg",{width:"9",height:"9",viewBox:"0 0 12 12",fill:"none",children:e.jsx("path",{d:"M2.5 6L5 8.5L9.5 3.5",stroke:"currentColor",strokeWidth:"1.7",strokeLinecap:"round",strokeLinejoin:"round"})})}),e.jsx("span",{className:"sel-opt-text sel-opt-dim",children:g})]}),l.map(x=>e.jsxs("li",{role:"option","aria-selected":x===d,className:`sel-opt${x===d?" sel-opt-on":""}`,onMouseDown:f=>f.preventDefault(),onClick:()=>{h(x),c(!1)},children:[e.jsx("span",{className:"sel-check","aria-hidden":"true",children:x===d&&e.jsx("svg",{width:"9",height:"9",viewBox:"0 0 12 12",fill:"none",children:e.jsx("path",{d:"M2.5 6L5 8.5L9.5 3.5",stroke:"currentColor",strokeWidth:"1.7",strokeLinecap:"round",strokeLinejoin:"round"})})}),e.jsx("span",{className:"sel-opt-text",children:x})]},x))]})]})}function va(){n.useEffect(()=>{const a=document.title;return document.title="MotorIA Risk Engine™",()=>{document.title=a}},[]);const[t,l]=n.useState(new Date);n.useEffect(()=>{const a=setInterval(()=>l(new Date),1e3);return()=>clearInterval(a)},[]);const[d,h]=n.useState(!1);n.useEffect(()=>{try{const a=new URLSearchParams(window.location.search),r=a.get("t")||a.get("token");if(r&&r.length>10){localStorage.setItem(K,r),re(r),h(!0),window.history.replaceState(null,"",window.location.pathname);const p=setTimeout(()=>h(!1),4200);return()=>clearTimeout(p)}}catch{}},[]);const[g,m]=n.useState(!1),[c,L]=n.useState("jogos"),[x,f]=n.useState("lista");function k(a){L(a),m(!1),a==="jogos"&&(f("lista"),S(null),z(""))}const[q,M]=n.useState(""),[Q,P]=n.useState(""),[y,X]=n.useState("Resultado da partida"),[w,I]=n.useState(""),[Z,ge]=n.useState(""),[Fe,De]=n.useState(""),[A,W]=n.useState(!1),[v,me]=n.useState(0),[C,ee]=n.useState(0),[Y,z]=n.useState(""),[o,S]=n.useState(null),[b,$e]=n.useState(ia),[ae,re]=n.useState(()=>localStorage.getItem(K)||""),[he,Te]=n.useState(null),[be,Ve]=n.useState(null),[E,Be]=n.useState([]),[R,te]=n.useState(!1),[H,ue]=n.useState(""),[fe,Pe]=n.useState(null),[s,F]=n.useState(null),[U,We]=n.useState("todos");function ie(){te(!0),ue(""),fetch("/api/matches").then(a=>a.json()).then(a=>{Be(a.matches||[]),Pe(a.updatedAt?new Date(a.updatedAt):new Date),te(!1)}).catch(()=>{ue("Não foi possível carregar as partidas. Verifique sua conexão."),te(!1)})}n.useEffect(()=>{c==="jogos"&&(E.length>0&&!H||ie())},[c]);const _=parseFloat((w||"").replace(",",".")),se=w&&!isNaN(_)&&_>=1.01?Ie(_):null,D=b.length?Math.round(b.reduce((a,r)=>a+(r.score||0),0)/b.length):null,ve=b[0]||null;async function je({jogoVal:a,campVal:r,tipoVal:p,oddVal:u,valorVal:i}){const j=parseFloat(String(u).replace(",","."));W(!0),z(""),S(null),me(0),ee(V[0].pct);let N=0;const $=setInterval(()=>{N=Math.min(N+1,V.length-1),me(N),ee(V[N].pct)},820);try{const ne=`Aposta: ${a||"não informado"} | Campeonato: ${r||"não informado"} | Tipo: ${p} | Odd: ${u} | Valor: R$${i||"100"} | Obs: ${Fe||"nenhuma"}`,G=await fetch("/api/chat",{method:"POST",headers:{"Content-Type":"application/json",...ae?{"x-motoria-token":ae}:{}},body:JSON.stringify({tool:"chance_de_perder",userMessage:ne})});if(clearInterval($),G.status===402){window.location.href=ea;return}if(!G.ok){const Xe=await G.json().catch(()=>({}));z(Xe.error||"Erro ao processar análise."),W(!1);return}const O=await G.json(),Ge=O.content?.[0]?.text||"";O.credits!==void 0&&Te(O.credits),O.token&&(localStorage.setItem(K,O.token),re(O.token));const T=xe(j),ke=aa(j),Ke=T/(1-ke/100),ze=Math.min(Ke,99),Je=ra(T,j),qe=Ie(j),Qe=Math.min(100,Math.round((100-ze)*1.1)),Ce=parseFloat(i)||100,le={id:Math.floor(Math.random()*8e3)+2e3,ts:na(),jogo:a||"Aposta",tipo:p,odd:j,impl:T.toFixed(2),justa:ze.toFixed(2),vig:ke.toFixed(2),ev:Je.toFixed(2),perda:(100-T).toFixed(1),exposure:Qe,valorAposta:Ce,valorRisco:(Ce*(100-T)/100).toFixed(2),...qe,ai:ta(Ge)};S(le),Ve(le.id);const Ee=[le,...b].slice(0,Le);$e(Ee),sa(Ee),ee(100),setTimeout(()=>W(!1),280)}catch{clearInterval($),z("Erro de conexão. Tente novamente."),W(!1)}}function Ye(a){a.preventDefault();const r=parseFloat((w||"").replace(",","."));if(!w||isNaN(r)||r<1.01){z("Informe uma odd válida (mínimo 1.01).");return}je({jogoVal:q,campVal:Q,tipoVal:y,oddVal:w,valorVal:Z})}function oe(a,r){if(!a||!r)return;const p=s?`${s.home} × ${s.away}`:q,u=s?.campeonato||Q;X(a),I(String(r)),f("resultado"),je({jogoVal:p,campVal:u,tipoVal:a,oddVal:String(r),valorVal:Z||"100"})}function we(a){S(a),M(a.jogo||""),I(String(a.odd)),L("nova")}function ye(){S(null),z(""),M(""),I(""),ge(""),De(""),P(""),F(null),f("lista")}function He(a){const r=J(a.league);M(`${a.home} × ${a.away}`),P(r),F({...a,campeonato:r}),f("mercado")}function Ue(a){const r=Me(a.score),p=a.label==="CRÍTICO"?"MUITO ALTO":a.label,u=a.ai?.alertaFinal||a.ai?.leituraConservadora||r.sub;return e.jsxs("div",{className:"db-result-card",children:[e.jsxs("div",{className:"db-rc-header",children:[e.jsx("div",{className:"db-rc-event",children:a.jogo!=="Aposta"?a.jogo:a.tipo}),e.jsxs("div",{className:"db-rc-meta",children:[a.jogo!=="Aposta"&&e.jsx("span",{className:"db-rc-badge",children:a.tipo}),e.jsxs("span",{className:"db-rc-odd",children:["Odd ",a.odd.toFixed(2)]}),a.valorAposta&&e.jsxs("span",{className:"db-rc-valor",children:["R$ ",a.valorAposta.toFixed(0)]})]})]}),e.jsx("div",{className:"db-rc-divider"}),e.jsxs("div",{className:"db-rc-risk",children:[e.jsxs("div",{className:"db-rc-risk-top",children:[e.jsx("span",{className:"db-rc-label",children:"Risco da Aposta"}),e.jsx("span",{className:"db-rc-level",style:{color:a.color},children:p})]}),e.jsxs("div",{className:"db-rc-score",style:{color:a.color},children:[a.score,e.jsx("span",{className:"db-rc-score-denom",children:"/100"})]}),e.jsx("div",{className:"db-rbar-wrap",role:"img","aria-label":`Risco ${a.score} de 100`,children:e.jsxs("div",{className:"db-rbar-track",children:[e.jsx("div",{className:"db-rbar-zone db-rbar-z1"}),e.jsx("div",{className:"db-rbar-zone db-rbar-z2"}),e.jsx("div",{className:"db-rbar-zone db-rbar-z3"}),e.jsx("div",{className:"db-rbar-zone db-rbar-z4"}),e.jsx("div",{className:"db-rbar-marker",style:{left:`calc(${Math.min(a.score,98)}% - 5px)`}})]})}),e.jsx("div",{className:"db-rc-phrase",children:Oe(a.score)})]}),e.jsx("div",{className:"db-rc-divider"}),e.jsxs("div",{className:"db-rc-data",children:[e.jsxs("div",{className:"db-rc-data-item",children:[e.jsx("span",{className:"db-rc-label",children:"Chance estimada"}),e.jsxs("span",{className:"db-rc-big db-rc-big-green",children:[a.impl,e.jsx("span",{className:"db-rc-sym",children:"%"})]}),e.jsxs("span",{className:"db-rc-sub",children:[a.perda,"% de não converter"]})]}),e.jsx("div",{className:"db-rc-data-sep"}),e.jsxs("div",{className:"db-rc-data-item",children:[e.jsx("span",{className:"db-rc-label",children:"Valor em risco"}),e.jsxs("span",{className:"db-rc-big",style:{color:a.color},children:["R$",e.jsx("span",{children:a.valorRisco||"—"})]}),e.jsxs("span",{className:"db-rc-sub",children:["de R$ ",a.valorAposta?.toFixed(0)||"—"," apostados"]})]})]}),e.jsx("div",{className:"db-rc-divider"}),e.jsxs("div",{className:"db-rc-ai",children:[e.jsx("span",{className:"db-rc-label",children:"Leitura da IA"}),e.jsxs("div",{className:"db-rc-ai-verdict",style:{color:r.color},children:[e.jsx("span",{className:"db-rc-ai-dot",style:{background:r.color},"aria-hidden":"true"}),r.text]}),u&&e.jsxs("p",{className:"db-rc-ai-sentence",children:['"',u,'"']})]})]})}function Ne(a){const r=a.label==="CRÍTICO"?"MUITO ALTO":a.label,p=a.ai?.alertaFinal||a.ai?.leituraConservadora||"",u=[`MotorIA Pro · Análise #${a.id}`,`${a.jogo} | ${a.tipo} | Odd ${a.odd.toFixed(2)}`,"",`Risco da Aposta: ${a.score}/100 · ${r}`,`Chance Estimada: ${a.impl}%`,a.valorRisco?`Valor em Risco: R$ ${a.valorRisco}`:null,p?`Leitura da IA: "${p}"`:null,"","Análise educativa. Não representa garantia de resultado."].filter(Boolean).join(`
`);navigator.clipboard.writeText(u).catch(()=>{})}const _e=[{group:"ANÁLISE",items:[{id:"jogos",label:"Jogos de Hoje",Icon:ha},{id:"nova",label:"Análise Manual",Icon:da,manual:!0},{id:"geral",label:"Visão Geral",Icon:la},{id:"comparador",label:"Comparador",Icon:pa,dim:!0}]},{group:"MERCADOS",items:[{id:"aovivo",label:"Ao Vivo",Icon:ca,live:!0,dim:!0},{id:"favoritos",label:"Favoritos",Icon:xa,dim:!0}]},{group:"ARQUIVO",items:[{id:"historico",label:"Histórico",Icon:ga,badge:b.length||null}]},{group:"SISTEMA",items:[{id:"config",label:"Configurações",Icon:ma}]}];return e.jsxs(e.Fragment,{children:[e.jsx("style",{children:ba}),g&&e.jsx("div",{className:"ap-overlay",onClick:()=>m(!1),"aria-hidden":"true"}),d&&e.jsxs("div",{className:"ap-access-banner",role:"status","aria-live":"polite",children:[e.jsx("span",{className:"ap-access-banner-dot","aria-hidden":"true"}),"Acesso ativado — plataforma pronta para uso"]}),e.jsxs("div",{className:"ap-shell",children:[e.jsx("header",{className:"ap-topbar",children:e.jsxs("div",{className:"ap-topbar-row",children:[e.jsxs("div",{className:"ap-topbar-left",children:[e.jsxs("button",{className:"ap-hamburger",onClick:()=>m(a=>!a),"aria-label":"Menu","aria-expanded":g,children:[e.jsx("span",{}),e.jsx("span",{}),e.jsx("span",{})]}),e.jsxs("div",{className:"ap-topbar-brand",children:[e.jsx("div",{className:"ap-logo-mark","aria-hidden":"true",children:e.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 14 14",fill:"none",children:[e.jsx("path",{d:"M7 1L13 4V10L7 13L1 10V4L7 1Z",fill:"#060608"}),e.jsx("path",{d:"M7 1L13 4V10L7 13L1 10V4L7 1Z",fill:"currentColor",fillOpacity:".95"})]})}),e.jsx("span",{className:"ap-topbar-name",children:"MotorIA"}),e.jsx("span",{className:"ap-topbar-sep","aria-hidden":"true",children:"·"}),e.jsx("span",{className:"ap-topbar-tag",children:"Risk Engine™"})]})]}),e.jsxs("div",{className:"ap-topbar-center",children:[e.jsx("span",{className:"ap-topbar-clock",children:oa(t)}),be&&e.jsxs("span",{className:"ap-topbar-aid",children:[" · #",be]})]}),e.jsxs("div",{className:"ap-topbar-right",children:[he!==null&&e.jsx("div",{className:"ap-credits-wrap",title:"Créditos restantes",children:e.jsx("div",{className:"ap-credits-bar",children:e.jsx("div",{className:"ap-credits-fill",style:{width:`${Math.max(0,he/20*100)}%`}})})}),e.jsxs("div",{className:"ap-engine-live",children:[e.jsx("span",{className:"ap-live-dot","aria-hidden":"true"}),e.jsx("span",{className:"ap-live-lbl",children:"IA ONLINE"})]})]})]})}),e.jsxs("div",{className:"ap-body",children:[e.jsxs("nav",{className:`ap-sidebar${g?" ap-sidebar-open":""}`,"aria-label":"Navegação",children:[e.jsxs("div",{className:"ap-sidebar-brand",children:[e.jsx("div",{className:"ap-sidebar-brand-mark","aria-hidden":"true",children:e.jsx("svg",{width:"9",height:"9",viewBox:"0 0 14 14",fill:"none",children:e.jsx("path",{d:"M7 1L13 4V10L7 13L1 10V4L7 1Z",fill:"#22C55E"})})}),e.jsx("span",{className:"ap-sidebar-brand-name",children:"MotorIA Pro"})]}),e.jsx("div",{className:"ap-sidebar-divider",role:"separator"}),_e.map(({group:a,items:r})=>e.jsxs("div",{className:"ap-sidebar-group",children:[e.jsx("div",{className:"ap-sidebar-group-lbl",children:a}),r.map(({id:p,label:u,Icon:i,badge:j,live:N,dim:$,manual:ne})=>e.jsxs("button",{className:`ap-nav-item${c===p?" ap-nav-active":""}${$?" ap-nav-dim":""}${ne?" ap-nav-manual":""}`,onClick:()=>k(p),"aria-current":c===p?"page":void 0,children:[e.jsx("span",{className:"ap-nav-icon",children:e.jsx(i,{})}),e.jsx("span",{className:"ap-nav-label",children:u}),N&&e.jsx("span",{className:"ap-nav-live-dot","aria-label":"ao vivo"}),j>0&&!N&&e.jsx("span",{className:"ap-nav-badge","aria-label":`${j} itens`,children:j}),$&&!N&&e.jsx("span",{className:"ap-nav-soon","aria-label":"em breve",children:e.jsxs("svg",{width:"8",height:"8",viewBox:"0 0 10 10",fill:"none",children:[e.jsx("path",{d:"M5 2v3.5M5 7v.5",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round"}),e.jsx("circle",{cx:"5",cy:"5",r:"4",stroke:"currentColor",strokeWidth:"1.2",opacity:".5"})]})})]},p))]},a)),e.jsxs("div",{className:"ap-sidebar-engine",children:[e.jsx("div",{className:"ap-sidebar-engine-dot","aria-hidden":"true"}),e.jsxs("div",{className:"ap-sidebar-engine-info",children:[e.jsx("span",{className:"ap-sidebar-engine-name",children:"RISK ENGINE v2.4"}),e.jsx("span",{className:"ap-sidebar-engine-status",children:"ONLINE"})]})]})]}),e.jsxs("main",{className:"ap-main",children:[c==="geral"&&e.jsxs("div",{className:"ap-content",children:[e.jsxs("div",{className:"ap-panel-hdr",children:[e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:"MÓDULO I"}),e.jsx("div",{className:"ap-panel-title",children:"Visão Geral"})]}),e.jsxs("div",{className:"ap-panel-online",children:[e.jsx("span",{className:"ap-status-dot","aria-hidden":"true"}),"SISTEMA ONLINE"]})]}),e.jsxs("div",{className:"ap-geral-stats",children:[e.jsxs("div",{className:"ap-geral-stat",children:[e.jsx("div",{className:"ap-geral-stat-val",children:b.length}),e.jsx("div",{className:"ap-geral-stat-lbl",children:"ANÁLISES"})]}),e.jsxs("div",{className:"ap-geral-stat",children:[e.jsx("div",{className:"ap-geral-stat-val",style:{color:D!==null?D>60?"#EF4444":D>40?"#F59E0B":"#22C55E":"var(--t3)"},children:D!==null?D:"—"}),e.jsx("div",{className:"ap-geral-stat-lbl",children:"SCORE MÉDIO"})]}),e.jsxs("div",{className:"ap-geral-stat",children:[e.jsx("div",{className:"ap-geral-stat-val",children:ve?ve.odd.toFixed(2):"—"}),e.jsx("div",{className:"ap-geral-stat-lbl",children:"ÚLTIMA ODD"})]}),e.jsxs("div",{className:"ap-geral-stat",children:[e.jsx("div",{className:"ap-geral-stat-val ap-geral-stat-val-sm",children:"v2.4"}),e.jsx("div",{className:"ap-geral-stat-lbl",children:"ENGINE"})]})]}),e.jsxs("div",{className:"ap-geral-action",children:[e.jsxs("div",{className:"ap-geral-action-left",children:[e.jsx("div",{className:"ap-geral-action-title",children:"Iniciar nova análise quantitativa"}),e.jsx("div",{className:"ap-geral-action-sub",children:"MOTORIA RISK INDEX™ · Probabilidade · EV · Exposição"})]}),e.jsxs("button",{className:"ap-geral-btn",onClick:()=>k("nova"),children:["Analisar",e.jsx("svg",{width:"11",height:"11",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M2.5 7H11.5M11.5 7L8 3.5M11.5 7L8 10.5",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})})]})]}),b.length>0&&e.jsxs("div",{className:"ap-geral-recent",children:[e.jsx("div",{className:"ap-geral-recent-hdr",children:"ANÁLISES RECENTES"}),e.jsx("div",{className:"ap-geral-recent-list",children:b.slice(0,4).map((a,r)=>e.jsxs("button",{className:"ap-geral-recent-row",onClick:()=>we(a),children:[e.jsxs("span",{className:"ap-geral-recent-id",children:["#",a.id]}),e.jsx("span",{className:"ap-geral-recent-event",children:a.jogo||"Aposta"}),e.jsxs("span",{className:"ap-geral-recent-odd",children:["Odd ",a.odd]}),e.jsx("div",{className:"ap-geral-recent-bar",children:e.jsx("div",{style:{width:`${a.score}%`,background:a.color,height:"100%",borderRadius:99}})}),e.jsx("span",{className:"ap-geral-recent-score",style:{color:a.color},children:a.score}),e.jsx("span",{className:"ap-geral-recent-tag",style:{color:a.color},children:a.label})]},r))})]}),b.length===0&&e.jsxs("div",{className:"ap-geral-empty",children:[e.jsx("p",{children:"Nenhuma análise registrada ainda."}),e.jsx("button",{className:"ap-geral-btn",onClick:()=>k("nova"),children:"Iniciar primeira análise →"})]})]},"geral"),c==="nova"&&e.jsxs("div",{className:"ap-content ap-content-nova",children:[s&&!o&&!A&&e.jsxs("div",{className:`ap-game-strip${s.status==="live"?" ap-game-strip-live":""}`,children:[e.jsx("span",{className:`ap-game-strip-dot${s.status==="live"?" ap-gsd-live":""}`,"aria-hidden":"true"}),e.jsxs("span",{className:"ap-game-strip-text",children:[s.home," × ",s.away]}),s.campeonato&&e.jsx("span",{className:"ap-game-strip-league",children:s.campeonato}),s.status==="live"?e.jsxs("span",{className:"ap-gsd-live-badge",children:["AO VIVO",s.elapsed?` · ${s.elapsed}'`:""]}):s.time?e.jsx("span",{className:"ap-game-strip-time",children:s.time}):null,e.jsx("button",{className:"ap-game-strip-clear",onClick:()=>{F(null),M(""),P("")},"aria-label":"Remover jogo selecionado",type:"button",children:"×"})]}),!o&&!A&&e.jsx("section",{className:"ap-input-panel",children:e.jsxs("form",{className:"ap-form",onSubmit:Ye,noValidate:!0,children:[e.jsxs("div",{className:"ap-row-2",children:[e.jsxs("div",{className:"ap-field",children:[e.jsx("label",{className:"ap-label",htmlFor:"odd-input",children:"ODD"}),e.jsx("input",{id:"odd-input",className:"ap-input ap-input-odd",type:"text",placeholder:"2.80",value:w,onChange:a=>I(a.target.value),inputMode:"decimal",autoComplete:"off"}),se&&e.jsxs("div",{className:"ap-odd-preview",style:{color:se.color},children:[e.jsx("span",{children:se.label}),e.jsx("span",{className:"ap-odd-preview-sep",children:"·"}),e.jsxs("span",{children:["chance ",xe(_).toFixed(0),"%"]})]})]}),e.jsxs("div",{className:"ap-field",children:[e.jsx("label",{className:"ap-label",htmlFor:"valor-input",children:"QUANTO VAI APOSTAR?"}),e.jsx("input",{id:"valor-input",className:"ap-input",type:"text",placeholder:"R$ 100",value:Z,onChange:a=>ge(a.target.value),inputMode:"decimal",autoComplete:"off"})]})]}),e.jsxs("div",{className:"ap-field",children:[e.jsx("label",{className:"ap-label",htmlFor:"tipo-input",children:"TIPO DE APOSTA"}),e.jsx(ce,{id:"tipo-input",options:Ae,value:y,onChange:X})]}),s&&de[y]&&!w&&e.jsxs("div",{className:"ap-odd-sug",children:[e.jsx("span",{className:"ap-odd-sug-icon","aria-hidden":"true",children:"💡"}),e.jsxs("span",{className:"ap-odd-sug-text",children:["Odd referência para ",e.jsx("em",{children:y}),":"," ",e.jsx("strong",{children:de[y]})]}),e.jsx("button",{type:"button",className:"ap-odd-sug-btn",onClick:()=>I(de[y]),children:"Usar"})]}),e.jsxs("div",{className:"ap-row-2 ap-row-secondary",children:[e.jsxs("div",{className:"ap-field",children:[e.jsx("label",{className:"ap-label ap-label-dim",htmlFor:"camp-input",children:"CAMPEONATO"}),e.jsx(ce,{id:"camp-input",options:Ze,value:Q,onChange:P,placeholder:"Selecionar"})]}),e.jsxs("div",{className:"ap-field",children:[e.jsx("label",{className:"ap-label ap-label-dim",htmlFor:"jogo-input",children:"PARTIDA"}),e.jsx("input",{id:"jogo-input",className:"ap-input",type:"text",placeholder:"Ex: Flamengo × Palmeiras",value:q,onChange:a=>M(a.target.value),autoComplete:"off"})]})]}),Y&&e.jsx("div",{className:"ap-error",role:"alert",children:Y}),e.jsx("button",{className:"ap-submit",type:"submit",children:"INICIAR ANÁLISE →"})]})}),A&&e.jsxs("div",{className:"ap-loading",role:"status","aria-live":"polite",children:[e.jsxs("div",{className:"ap-loading-hdr",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"ap-loading-engine",children:["RISK ENGINE v2.4",e.jsx("span",{className:"ap-loading-engine-dot","aria-hidden":"true"})]}),s?e.jsxs("div",{className:"ap-loading-sub ap-loading-sub-game",children:[s.home," × ",s.away]}):e.jsx("div",{className:"ap-loading-sub",children:"Processamento quantitativo em execução"})]}),e.jsx("span",{className:"ap-loading-status",children:"CALCULANDO"})]}),e.jsxs("div",{className:"ap-loading-bar-wrap",children:[e.jsx("div",{className:"ap-loading-bar",style:{width:`${C}%`}}),e.jsx("div",{className:"ap-loading-bar-glow",style:{left:`${C}%`}})]}),e.jsxs("div",{className:"ap-loading-pct","aria-label":`${C}%`,children:[C,e.jsx("span",{className:"ap-loading-pct-sym",children:"%"})]}),e.jsx("div",{className:"ap-loading-steps",children:V.map((a,r)=>e.jsxs("div",{className:`ap-lstep${r<v?" ap-lstep-done":r===v?" ap-lstep-active":""}`,children:[e.jsx("span",{className:"ap-lstep-icon","aria-hidden":"true",children:r<v?"✓":r===v?"▶":"○"}),e.jsx("span",{className:"ap-lstep-lbl",children:a.label}),r===v&&e.jsx("span",{className:"ap-lstep-cursor","aria-hidden":"true",children:"_"}),r<v&&e.jsx("span",{className:"ap-lstep-done-tag",children:"OK"})]},r))})]}),o&&!A&&(()=>{const a=Me(o.score),r=o.label==="CRÍTICO"?"MUITO ALTO":o.label,p=o.ai?.alertaFinal||o.ai?.leituraConservadora||a.sub;return e.jsxs("div",{className:"db-output",role:"region","aria-label":"Resultado da análise",children:[e.jsxs("div",{className:"db-topbar",children:[e.jsxs("div",{className:"db-topbar-meta",children:[e.jsxs("span",{className:"db-id",children:["#",o.id]}),e.jsx("span",{className:"db-sep","aria-hidden":"true",children:"·"}),e.jsx("span",{className:"db-ts",children:o.ts}),e.jsx("span",{className:"db-sep","aria-hidden":"true",children:"·"}),e.jsxs("span",{className:"db-ai-badge",children:[e.jsx("span",{className:"db-ai-dot","aria-hidden":"true"}),"IA ativa"]})]}),e.jsx("button",{className:"db-btn-ghost",onClick:ye,"aria-label":"Nova análise",children:"Nova análise →"})]}),e.jsxs("div",{className:"db-result-card",children:[e.jsxs("div",{className:"db-rc-header",children:[e.jsx("div",{className:"db-rc-event",children:o.jogo!=="Aposta"?o.jogo:o.tipo}),e.jsxs("div",{className:"db-rc-meta",children:[o.jogo!=="Aposta"&&e.jsx("span",{className:"db-rc-badge",children:o.tipo}),e.jsxs("span",{className:"db-rc-odd",children:["Odd ",o.odd.toFixed(2)]}),o.valorAposta&&e.jsxs("span",{className:"db-rc-valor",children:["R$ ",o.valorAposta.toFixed(0)]})]})]}),e.jsx("div",{className:"db-rc-divider"}),e.jsxs("div",{className:"db-rc-risk",children:[e.jsxs("div",{className:"db-rc-risk-top",children:[e.jsx("span",{className:"db-rc-label",children:"Risco da Aposta"}),e.jsx("span",{className:"db-rc-level",style:{color:o.color},children:r})]}),e.jsxs("div",{className:"db-rc-score",style:{color:o.color},children:[o.score,e.jsx("span",{className:"db-rc-score-denom",children:"/100"})]}),e.jsx("div",{className:"db-rbar-wrap",role:"img","aria-label":`Risco ${o.score} de 100`,children:e.jsxs("div",{className:"db-rbar-track",children:[e.jsx("div",{className:"db-rbar-zone db-rbar-z1"}),e.jsx("div",{className:"db-rbar-zone db-rbar-z2"}),e.jsx("div",{className:"db-rbar-zone db-rbar-z3"}),e.jsx("div",{className:"db-rbar-zone db-rbar-z4"}),e.jsx("div",{className:"db-rbar-marker",style:{left:`calc(${Math.min(o.score,98)}% - 5px)`}})]})}),e.jsx("div",{className:"db-rc-phrase",children:Oe(o.score)})]}),e.jsx("div",{className:"db-rc-divider"}),e.jsxs("div",{className:"db-rc-data",children:[e.jsxs("div",{className:"db-rc-data-item",children:[e.jsx("span",{className:"db-rc-label",children:"Chance estimada"}),e.jsxs("span",{className:"db-rc-big db-rc-big-green",children:[o.impl,e.jsx("span",{className:"db-rc-sym",children:"%"})]}),e.jsxs("span",{className:"db-rc-sub",children:[o.perda,"% de não converter"]})]}),e.jsx("div",{className:"db-rc-data-sep"}),e.jsxs("div",{className:"db-rc-data-item",children:[e.jsx("span",{className:"db-rc-label",children:"Valor em risco"}),e.jsxs("span",{className:"db-rc-big",style:{color:o.color},children:["R$",e.jsx("span",{children:o.valorRisco||"—"})]}),e.jsxs("span",{className:"db-rc-sub",children:["de R$ ",o.valorAposta?.toFixed(0)||"—"," apostados"]})]})]}),e.jsx("div",{className:"db-rc-divider"}),e.jsxs("div",{className:"db-rc-ai",children:[e.jsx("span",{className:"db-rc-label",children:"Leitura da IA"}),e.jsxs("div",{className:"db-rc-ai-verdict",style:{color:a.color},children:[e.jsx("span",{className:"db-rc-ai-dot",style:{background:a.color},"aria-hidden":"true"}),a.text]}),p&&e.jsxs("p",{className:"db-rc-ai-sentence",children:['"',p,'"']})]})]}),e.jsxs("div",{className:"db-actions",children:[e.jsxs("button",{className:"db-btn-primary",onClick:ye,children:[e.jsx("svg",{width:"11",height:"11",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M2.5 7H11.5M11.5 7L8 3.5M11.5 7L8 10.5",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})}),"Nova análise"]}),e.jsxs("button",{className:"db-btn-copy",onClick:()=>Ne(o),title:"Copiar resumo",children:[e.jsxs("svg",{width:"11",height:"11",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("rect",{x:"5",y:"5",width:"8",height:"8",rx:"1.5",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M9 5V3a1 1 0 00-1-1H3a1 1 0 00-1 1v5a1 1 0 001 1h2",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round"})]}),"Copiar"]})]}),e.jsx("p",{className:"db-disclaimer",children:"Análise educativa. Não representa garantia de resultado. A decisão é sua."})]})})()]},"nova"),c==="comparador"&&e.jsx(pe,{mod:"MÓDULO III",title:"Comparador de Odds",desc:"Compare múltiplas odds simultaneamente e identifique distorções entre casas de apostas. O Comparador cruza probabilidades implícitas em tempo real."}),c==="aovivo"&&e.jsx(pe,{mod:"MERCADOS",title:"Ao Vivo",desc:"Feed de análises em tempo real com atualizações automáticas de probabilidade para eventos em andamento. Integração com dados de mercado ao vivo."}),c==="favoritos"&&e.jsx(pe,{mod:"ARQUIVO",title:"Favoritos",desc:"Salve e organize suas análises mais relevantes. Crie coleções por campeonato, mercado ou período para consulta rápida."}),c==="jogos"&&e.jsxs("div",{className:"ap-content ap-content-flow",children:[x==="lista"&&e.jsxs("div",{className:"fl-step",children:[e.jsxs("div",{className:"ap-panel-hdr",children:[e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:"ANÁLISE ESPORTIVA"}),e.jsx("div",{className:"ap-panel-title",children:"Jogos de Hoje"})]}),e.jsxs("div",{className:"jg-hdr-right",children:[e.jsxs("div",{className:"jg-data-badge",children:[e.jsx("span",{className:"jg-data-dot","aria-hidden":"true"}),"DADOS ESPORTIVOS"]}),fe&&e.jsx("span",{className:"jg-updated",children:fe.toLocaleTimeString("pt-BR",{hour:"2-digit",minute:"2-digit"})}),e.jsx("button",{className:"jg-refresh-btn",onClick:ie,disabled:R,title:"Atualizar",type:"button","aria-label":"Atualizar partidas",children:e.jsx("svg",{width:"12",height:"12",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M12 7A5 5 0 1 1 7 2M12 7V2.5M12 2.5H8",stroke:"currentColor",strokeWidth:"1.5",strokeLinecap:"round",strokeLinejoin:"round"})})})]})]}),R&&e.jsxs("div",{className:"jg-loading",children:[e.jsx("span",{className:"jg-dot"}),e.jsx("span",{className:"jg-dot"}),e.jsx("span",{className:"jg-dot"}),e.jsx("span",{className:"jg-loading-lbl",children:"Buscando partidas..."})]}),H&&!R&&e.jsxs("div",{className:"ap-error",role:"alert",children:[H,e.jsx("button",{className:"jg-retry-btn",onClick:ie,type:"button",children:"Tentar novamente"})]}),!R&&E.length===0&&!H&&e.jsxs("div",{className:"ap-geral-empty",children:[e.jsx("p",{children:"Nenhuma partida encontrada para hoje."}),e.jsx("button",{className:"ap-geral-btn",onClick:()=>k("nova"),children:"Análise manual →"})]}),!R&&E.length>0&&(()=>{const a=E.filter(i=>i.status==="live").length,r=[...new Set(E.map(i=>J(i.league)).filter(Boolean))],p=["todos",...a>0?["live"]:[],...r],u=U==="todos"?E:U==="live"?E.filter(i=>i.status==="live"):E.filter(i=>J(i.league)===U);return e.jsxs(e.Fragment,{children:[e.jsx("div",{className:"jg-filters",children:p.map(i=>e.jsx("button",{className:["jg-pill",U===i?"jg-pill-on":"",i==="live"?"jg-pill-live":""].join(" ").trim(),onClick:()=>We(i),type:"button",children:i==="todos"?"Todos":i==="live"?e.jsxs(e.Fragment,{children:[e.jsx("span",{className:"jg-pill-dot","aria-hidden":"true"}),"Ao Vivo (",a,")"]}):i},i))}),e.jsx("div",{className:"jg-grid",children:u.map((i,j)=>{const N=i.scoreHome!==null&&i.scoreAway!==null;return e.jsxs("button",{className:`jg-card jg-card-${i.status}`,onClick:()=>He(i),type:"button",style:{animationDelay:`${Math.min(j,6)*40}ms`},children:[e.jsxs("div",{className:"jg-card-header",children:[e.jsx("span",{className:"jg-league",children:J(i.league)||i.league}),i.status==="upcoming"&&i.time&&e.jsx("span",{className:"jg-time",children:i.time})]}),i.status==="live"&&e.jsxs("div",{className:"jg-status-row",children:[e.jsx("span",{className:"jg-live-dot","aria-hidden":"true"}),e.jsx("span",{className:"jg-status-live-text",children:"AO VIVO"}),i.elapsed!=null&&e.jsxs("span",{className:"jg-elapsed",children:[i.elapsed,"'"]})]}),i.status==="ended"&&e.jsx("div",{className:"jg-status-row",children:e.jsx("span",{className:"jg-status-ended-text",children:"ENCERRADO"})}),e.jsxs("div",{className:"jg-matchup",children:[e.jsx("span",{className:"jg-team-name",children:i.home}),e.jsx("div",{className:"jg-score-center",children:N?e.jsxs("span",{className:"jg-score-pair",children:[e.jsx("span",{className:"jg-score-num",children:i.scoreHome}),e.jsx("span",{className:"jg-score-dash",children:"—"}),e.jsx("span",{className:"jg-score-num",children:i.scoreAway})]}):e.jsx("span",{className:"jg-vs",children:"×"})}),e.jsx("span",{className:"jg-team-name jg-team-right",children:i.away})]}),e.jsx("div",{className:"jg-card-footer",children:e.jsx("span",{className:"jg-cta",children:"Escolher mercado →"})})]},i.id||j)})}),e.jsxs("div",{className:"jg-disclaimer",role:"note",children:[e.jsxs("svg",{width:"10",height:"10",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("circle",{cx:"7",cy:"7",r:"5.5",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M7 6.5v3.5M7 4.5v.5",stroke:"currentColor",strokeWidth:"1.4",strokeLinecap:"round"})]}),"Ferramenta educativa. Dados de partidas para contexto de análise de risco. Não é recomendação de aposta."]})]})})()]}),x==="mercado"&&s&&e.jsxs("div",{className:"fl-step",children:[e.jsxs("button",{className:"fl-back-btn",onClick:()=>{F(null),f("lista")},type:"button",children:[e.jsx("svg",{width:"10",height:"10",viewBox:"0 0 12 12",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M8 2L4 6L8 10",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})}),"Mudar partida"]}),e.jsxs("div",{className:`fl-game-hero${s.status==="live"?" fl-game-hero-live":""}`,children:[e.jsxs("div",{className:"fl-hero-meta",children:[e.jsx("span",{className:"fl-hero-league",children:s.campeonato}),s.status==="live"?e.jsxs("div",{className:"fl-hero-status-live",children:[e.jsx("span",{className:"fl-hero-live-dot","aria-hidden":"true"}),"AO VIVO",s.elapsed?` · ${s.elapsed}'`:""]}):s.time?e.jsx("span",{className:"fl-hero-time",children:s.time}):null]}),e.jsxs("div",{className:"fl-teams",children:[e.jsx("span",{className:"fl-team",children:s.home}),e.jsx("span",{className:"fl-vs",children:"×"}),e.jsx("span",{className:"fl-team fl-team-right",children:s.away})]})]}),e.jsx("div",{className:"fl-section-hdr",children:"ESCOLHA O MERCADO"}),e.jsx("div",{className:"fl-market-grid",children:Se.map(a=>e.jsxs("button",{className:"fl-market-btn",onClick:()=>oe(a.tipo,a.ref),type:"button",children:[e.jsx("span",{className:"fl-market-name",children:a.tipo}),e.jsxs("span",{className:"fl-market-ref",children:["Ref. ",a.ref]})]},a.tipo))}),e.jsxs("div",{className:"fl-sep",children:[e.jsx("span",{className:"fl-sep-line","aria-hidden":"true"}),e.jsx("span",{className:"fl-sep-lbl",children:"ou informe sua odd"}),e.jsx("span",{className:"fl-sep-line","aria-hidden":"true"})]}),e.jsxs("div",{className:"fl-custom-row",children:[e.jsx("div",{className:"fl-custom-tipo",children:e.jsx(ce,{id:"fl-tipo",options:Ae,value:y,onChange:X})}),e.jsx("input",{className:"ap-input ap-input-odd fl-custom-odd",type:"text",placeholder:"2.80",value:w,onChange:a=>I(a.target.value),inputMode:"decimal",autoComplete:"off","aria-label":"Sua odd"}),e.jsx("button",{className:"fl-custom-submit",onClick:()=>oe(y,w),disabled:!w,type:"button",children:"ANALISAR →"})]}),e.jsx("button",{className:"fl-manual-link",onClick:()=>k("nova"),type:"button",children:"Abrir análise manual completa →"})]}),x==="resultado"&&e.jsxs("div",{className:"fl-step",children:[s&&e.jsxs("div",{className:`fl-ctx-strip${s.status==="live"?" fl-ctx-live":""}`,children:[e.jsx("span",{className:"fl-ctx-dot","aria-hidden":"true"}),e.jsxs("span",{className:"fl-ctx-match",children:[s.home," × ",s.away]}),e.jsx("span",{className:"fl-ctx-sep","aria-hidden":"true",children:"·"}),e.jsx("span",{className:"fl-ctx-tipo",children:y}),s.status==="live"&&e.jsx("span",{className:"fl-ctx-live-badge",children:"AO VIVO"})]}),A&&e.jsxs("div",{className:"ap-loading",role:"status","aria-live":"polite",children:[e.jsxs("div",{className:"ap-loading-hdr",children:[e.jsxs("div",{children:[e.jsxs("div",{className:"ap-loading-engine",children:["RISK ENGINE v2.4",e.jsx("span",{className:"ap-loading-engine-dot","aria-hidden":"true"})]}),e.jsx("div",{className:"ap-loading-sub ap-loading-sub-game",children:s?`${s.home} × ${s.away}`:"Processando análise"})]}),e.jsx("span",{className:"ap-loading-status",children:"CALCULANDO"})]}),e.jsxs("div",{className:"ap-loading-bar-wrap",children:[e.jsx("div",{className:"ap-loading-bar",style:{width:`${C}%`}}),e.jsx("div",{className:"ap-loading-bar-glow",style:{left:`${C}%`}})]}),e.jsxs("div",{className:"ap-loading-pct","aria-label":`${C}%`,children:[C,e.jsx("span",{className:"ap-loading-pct-sym",children:"%"})]}),e.jsx("div",{className:"ap-loading-steps",children:V.map((a,r)=>e.jsxs("div",{className:`ap-lstep${r<v?" ap-lstep-done":r===v?" ap-lstep-active":""}`,children:[e.jsx("span",{className:"ap-lstep-icon","aria-hidden":"true",children:r<v?"✓":r===v?"▶":"○"}),e.jsx("span",{className:"ap-lstep-lbl",children:a.label}),r===v&&e.jsx("span",{className:"ap-lstep-cursor","aria-hidden":"true",children:"_"}),r<v&&e.jsx("span",{className:"ap-lstep-done-tag",children:"OK"})]},r))})]}),Y&&!A&&e.jsxs("div",{className:"ap-error",role:"alert",children:[Y,e.jsx("button",{className:"fl-retry",onClick:()=>{z(""),oe(y,w)},type:"button",children:"Tentar novamente"})]}),o&&!A&&e.jsxs("div",{className:"db-output",role:"region","aria-label":"Resultado da análise",children:[e.jsxs("div",{className:"db-topbar",children:[e.jsxs("div",{className:"db-topbar-meta",children:[e.jsxs("span",{className:"db-id",children:["#",o.id]}),e.jsx("span",{className:"db-sep","aria-hidden":"true",children:"·"}),e.jsx("span",{className:"db-ts",children:o.ts}),e.jsx("span",{className:"db-sep","aria-hidden":"true",children:"·"}),e.jsxs("span",{className:"db-ai-badge",children:[e.jsx("span",{className:"db-ai-dot","aria-hidden":"true"}),"IA ativa"]})]}),e.jsx("div",{className:"fl-result-nav",children:e.jsx("button",{className:"db-btn-ghost",onClick:()=>{S(null),z(""),f("mercado")},type:"button",children:"← Outro mercado"})})]}),Ue(o),Se.some(a=>a.ref===o.odd.toFixed(2))&&e.jsxs("div",{className:"fl-ref-note",children:["Análise com odd de referência (",o.odd.toFixed(2),"). Use a odd real da sua casa para maior precisão."]}),e.jsxs("div",{className:"db-actions",children:[e.jsxs("button",{className:"db-btn-primary",onClick:()=>{S(null),z(""),F(null),f("lista")},type:"button",children:[e.jsx("svg",{width:"11",height:"11",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:e.jsx("path",{d:"M2.5 7H11.5M11.5 7L8 3.5M11.5 7L8 10.5",stroke:"currentColor",strokeWidth:"1.6",strokeLinecap:"round",strokeLinejoin:"round"})}),"Nova partida"]}),e.jsxs("button",{className:"db-btn-copy",onClick:()=>Ne(o),type:"button",children:[e.jsxs("svg",{width:"11",height:"11",viewBox:"0 0 14 14",fill:"none","aria-hidden":"true",children:[e.jsx("rect",{x:"5",y:"5",width:"8",height:"8",rx:"1.5",stroke:"currentColor",strokeWidth:"1.3"}),e.jsx("path",{d:"M9 5V3a1 1 0 00-1-1H3a1 1 0 00-1 1v5a1 1 0 001 1h2",stroke:"currentColor",strokeWidth:"1.3",strokeLinecap:"round"})]}),"Copiar"]})]}),e.jsx("p",{className:"db-disclaimer",children:"Análise educativa. Não representa garantia de resultado. A decisão é sempre sua."})]})]})]},`jogos-${x}`),c==="historico"&&e.jsxs("div",{className:"ap-content",children:[e.jsxs("div",{className:"ap-panel-hdr",children:[e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:"ARQUIVO"}),e.jsx("div",{className:"ap-panel-title",children:"Histórico de análises"})]}),e.jsxs("div",{className:"ap-panel-online",children:[e.jsx("span",{className:"ap-status-dot","aria-hidden":"true"}),b.length," REGISTROS"]})]}),b.length===0?e.jsx("div",{className:"ap-empty",children:"Nenhuma análise registrada nesta sessão."}):e.jsx("div",{className:"ap-hist-list",children:b.map((a,r)=>e.jsxs("button",{className:"ap-hist-row",onClick:()=>we(a),children:[e.jsxs("span",{className:"ap-hist-id",children:["#",a.id||"—"]}),e.jsx("span",{className:"ap-hist-event",children:a.jogo||"Aposta"}),e.jsxs("span",{className:"ap-hist-odd",children:["Odd ",a.odd]}),e.jsx("div",{className:"ap-hist-bar",children:e.jsx("div",{style:{width:`${a.score}%`,background:a.color,height:"100%",borderRadius:99}})}),e.jsx("span",{className:"ap-hist-score",style:{color:a.color},children:a.score}),e.jsx("span",{className:"ap-hist-tag",style:{color:a.color,borderColor:`${a.color}33`},children:a.label}),e.jsx("span",{className:"ap-hist-ts",children:a.ts||""})]},r))})]},"historico"),c==="config"&&e.jsxs("div",{className:"ap-content",children:[e.jsx("div",{className:"ap-panel-hdr",children:e.jsxs("div",{className:"ap-panel-hdr-left",children:[e.jsx("div",{className:"ap-panel-mod",children:"SISTEMA"}),e.jsx("div",{className:"ap-panel-title",children:"Configurações"})]})}),e.jsxs("div",{className:"ap-config-panel",children:[e.jsxs("div",{className:"ap-config-field",children:[e.jsx("label",{className:"ap-label",htmlFor:"token-input",children:"TOKEN DE ACESSO"}),e.jsx("input",{id:"token-input",className:"ap-input ap-input-mono",type:"text",placeholder:"Cole seu token de acesso aqui",value:ae,onChange:a=>{re(a.target.value),localStorage.setItem(K,a.target.value)},autoComplete:"off",spellCheck:!1}),e.jsx("p",{className:"ap-config-hint",children:"Token recebido por email após a confirmação de acesso."})]}),e.jsxs("div",{className:"ap-config-info",children:[e.jsxs("div",{className:"ap-config-row",children:[e.jsx("span",{children:"Engine"}),e.jsx("span",{children:"MotorIA Risk Engine™ v2.4"})]}),e.jsxs("div",{className:"ap-config-row",children:[e.jsx("span",{children:"Modelo"}),e.jsx("span",{children:"Quantitative Risk v2"})]}),e.jsxs("div",{className:"ap-config-row",children:[e.jsx("span",{children:"Histórico local"}),e.jsxs("span",{children:[b.length," / ",Le]})]}),e.jsxs("div",{className:"ap-config-row",children:[e.jsx("span",{children:"Status"}),e.jsx("span",{className:"ap-config-online",children:"● ONLINE"})]})]})]})]},"config")]})]})]})]})}const ba=`
